...
\todo{u whot mate} Falls eine Serverimplementation mit dieser Stresssituation umgehen kann, erfüllt sie auch die Anforderung \reqNumberForLabel{exec:time} im Produktivbetrieb.
...
Wie in \todo{Seite} \cite[157]{douglass2003real} beschrieben, wird hierdurch die Verarbeitung einer hohen Datenmenge ermöglicht.
