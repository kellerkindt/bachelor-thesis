...
\newglossaryentry{github}{
	...
	description={
		...
		Änderungen an Quellcode können vorgeschlagen werden, und durch die Projektverantwortlichen übernommen werden. Bietet auch die Möglichkeit eine kontinuierlichen Integrationssoftware einzubinden, um automatisierte Tests auf momentanen Quellcode und auch für Änderungen auszuführen. Eine vorgeschlagene Änderung kann somit vor Übernahme auf Kompatibilität überprüft werden. \todo{.}
	}
}
