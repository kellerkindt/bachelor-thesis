...
So kann im allgemeinen \rustcinline{#[derive(Clone)]} genutzt werden um eine Datenstruktur oder eine Aufzählung klonbar zu machen oder \rustcinline{#[derive(Debug)]} um automatisch alle Felder in Text zu wandeln, ohne manuell Code schreiben zu müssen.
