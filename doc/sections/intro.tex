...
Zu dem zuvor beschriebenen Verhalten des Kommunikationsservers besteht bereits eine Implementation in C++. Dies ist aus Sicht der funktionalen Sicherheit (siehe \autoref{safety}) ein \todo{leidiges Thema}.
