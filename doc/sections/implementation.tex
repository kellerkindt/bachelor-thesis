...
Dies erlaubt das Hinzufügen von zwei weiteren Crates zum einbinden des externen C++ Algorithmus: \textit{libshim-sys} um den C++ Code in Rust zugänglich zu machen (analog zu \textit{libasn-sys}) und \textit{libshim} für die Implementation der \textit{Algorithm}-Schnittstelle und des Adaptercodes.
