...
Für die Anforderung \reqNumberForLabel{req:possible:external_algorith} (siehe \autoref{possible:external_algorith}) wird der Architekturentwurf erweitert.
\todo{\autoref{draft:architecture} relative simple, daher wenige module (YAGNI?), jetzt komplexer -> DIP}
...
\todo{show rust channels, command pattern(how awesome rust enums are, +cite!), facade...

\todo{updated architecture}
