...
Kleine Testprogramme und Experimente können auf dem \enquote{Spielplatz} unter \url{https://play.rust-lang.org} compiliert und ausgeführt werden, ohne hierfür eine lokale Installation zu benötigen.
...
\begin{itemize}
	...
	Hierbei werden Funktionen dynamisch über eine \enquote{vtable} aufgerufen, wodurch höhere Laufzeitkosten \todo{entstehen}.
