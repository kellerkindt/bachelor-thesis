...
\requirement{exec:mec}{Plattform MEC}{Die Implementation des Servers muss auf einem MEC Server mit dem Betriebssystem \todo{Ubuntu 14.04 LTS Server} ausführbar sein.}
