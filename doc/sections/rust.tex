...
Dynamische Arrays gibt es nicht, da diese zu oft Fehlerquellen seien \todo{cite!} (Abhilfe: \rustcinline{Vec<_>}, siehe \autoref{rust:stdlib}).
...
Das folgende Beispiel erstellt eine Slice auf ein Array oder eine andere Slice vom Index 2 bis inklusive Index 7: \rustcinline{let slice : &[u8] = &array[2..8];}
...
Felder einer Struktur können mit \rustcinline{pub} oder \rustcinline{pub(crate)} gekennzeichnet werden (siehe \autoref{rust:access_modifier}).

Seit Version 1.19 ist der Datentyp \rustcinline{union} auch in Rust vorhanden \cite{rust:v1.19}.
