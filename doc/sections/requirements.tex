...
\requirement{client:sectors}{Sektoren übertragen}{Der Server übermittelt dem Fahrzeug nach Registrierung alle bekannten Sektoren.}

\requirement{sensor:pause}{Sensoren abonnieren}{Sensoren werden bei keinem verbunden Fahrzeug abonniert.}

\requirement{sensor:resume}{Sensoren deabonnieren}{Sensoren werden bei verbunden Fahrzeugen deabonniert.}

\requirement{impl:algorithmus:to}{Sensordaten weitergeben}{Empfangene Sensordaten werden dekodiert und an den Fusions-Algorithmus übergeben.}

\requirement{impl:algorithmus:from}{Ergebnisse weitergeben}{Ergebnisse des Fusions-Algorithmus werden enkodiert un an die Fahrzeuge versendet.}
