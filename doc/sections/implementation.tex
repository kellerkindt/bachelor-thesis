...
Auf der Konsole wird \monospaceinline{Say: Hallo, Fassade!} \todo{.}.
...
In der \autoref{seq_dia:algorithm:cpp:binding} wird aufgezeigt, wie der C++ Algorithmus instantiiert, eine \textit{SensorFrame}-Nachricht weitergeleitet und eine \textit{RawMessage} verteilt wird.
Zur Vereinfachung sind hierzu einige Schritte, wie die Registrierung des Fahrzeugs, ausgelassen.
...
\begin{figure}[H]
	...
	{[on background layer]
		\fill[green!15] (-13,1) -- (-7,1) -- (-7,-16) -- (-13,-16) -- cycle;
		\fill[red!30!white!15] (-7,1) -- (1,1) -- (1,-16) -- (-7,-16) -- cycle;
		\fill[orange!40!white!15] (1,1) -- (13,1) -- (13,-16) -- (1,-16) -- cycle;
		\fill[cyan!8] (13,1) -- (21,1) -- (21,-16) -- (13,-16) -- cycle;
	}
	\begin{umlseqdiag} 
	...
	\begin{umlcall}[dt=5,op=update(SensorFrame), with return]{s}{a}
		\begin{umlcall}[op=SensorFrame, with return]{a}{ashim}
			\begin{umlcall}[op=SensorFrame,with return]{ashim}{q}
	...
	\begin{umlcall}[op=RawMessage,with return]{e}{i}
		\begin{umlcall}[op=RawMessage,with return]{i}{rshim}
			\begin{umlcall}[op=RawMessage,with return]{rshim}{ashim}
				\begin{umlcall}[op=RawMessage,with return]{ashim}{a}
					\begin{umlcall}[op=RawMessage,with return]{a}{v}
					\end{umlcall}
				\end{umlcall}
			\end{umlcall}
		\end{umlcall}
