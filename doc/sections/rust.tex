...
\begin{itemize}
	...
	Diese \enquote{Tore} können durch entsprechende Attribute (siehe \autoref{rust:attributes}) geöffnet werden, so ermöglicht (\rustcinline{#[feature(const_fn)]} die Definition von Konstante Funktionen (Stand \today).
