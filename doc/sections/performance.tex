...
Die Serverimplementierung des \gls{mec}-View-Projekts wird in einer \gls{mec}-Recheneinheit ausgeführt, um die Sensordaten der Sensoren möglichst schnell an die Fahrzeuge des Abdeckungsbereichs weiterleiten zu können.
