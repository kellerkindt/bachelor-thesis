...
Ein Client einer neuen Verbindung kann sich entweder als Fahrzeug oder als Sensor registrieren.
Nach Registratur stehen die jeweiligen Funktionen eines Fahrzeugs oder eines Sensor zu Verfügung.
...
\begin{itemize}
	\item \textbf{Als Fahrzeug registrieren} \\
	Ein neuer Client kann sich dem Server gegenüber als Fahrzeug registrieren.
	Der Client kann sich nur als Fahrzeug registrieren, wenn zuvor keine Registratur vorgenommen wurde.
	
	\item \textbf{Als Sensor registrieren} \\
	Ein neuer Client kann sich dem Server gegenüber als Sensor registrieren.
	Der Client kann sich nur als Sensor registrieren, wenn zuvor keine Registratur vorgenommen wurde.
\end{itemize}
...
%			\umlusecase[y=-4,name=u4]{Umfeldmodel übergeben}
		\end{umlsystem}
		\umlactor[x=-5.5,y=0]{Fahrzeug}
%		\umlactor[x=-6,y=-4]{Fusions-Algorithmus}
		\umlactor[x=5.5,y=-6]{Sensor}
...
Das Use-Case Diagramm in \autoref{use_case:car} zeigt \todo{...}
