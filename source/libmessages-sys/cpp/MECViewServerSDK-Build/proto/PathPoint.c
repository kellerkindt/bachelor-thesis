...
static asn_per_constraints_t asn_PER_memb_probybility_constr_3 = {
...
static asn_TYPE_tag2member_t asn_MAP_PathPoint_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* position-offset at 18 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* probybility at 19 */
};
