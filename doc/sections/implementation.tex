...
\todo{.}
Würde sich die \textit{ClientRegistration}-Nachricht auch auf dem C-Heap befinden, müsste entweder ein Zugriff über \enquote{raw-Pointer} (siehe \autoref{rust:ffi}) erfolgen oder die automatische Deallocation von Rust müsste verhindert und durch eine manuelle Deallocation ersetzt werden.
