...
\todo{https://github.com/rust-lang-nursery}
...
\begin{itemize}
	...
	In Rust schützt eine \textbf{Mutex} anstatt einem bestimmten Codeabschnitt, die beinhalteten Daten \cite[486]{rust:orly_programming}.
...
Es kann kein exklusiver Zugriff für die Kollektion erlangt werden kann, da für die Kollektion bereits lesend (oder exklusiv) an die Iteration verliehen ist.
Eine \javacinline{ConcurrentModificationException} (Java) oder  wird deshalb nicht benötigt \cite[116]{rust:orly_programming}.

\section{Closures}

\todo{Closures/Lambdas, Fn, FnOnce, FnMut}

\todo{closures are fast, orly, p.310}

\todo{Rust 1.25: impl Trait}
...
\todo{internal unsafe to make safe interface, rust programming cite!}
