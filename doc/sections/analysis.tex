...
Aktionen in \enquote{loop}-Abschnitten werden so lange wiederholt, bis die erste darauf folgende Aktion außerhalb eines \enquote{loop}-Abschnittes eintritt \todo{satz}.
...
Der Sensor versendet darauf folgend in regelmäßigen Abständen \textit{SensorIdleFrame}-Nachrichten (siehe \autoref{msg:sensor_idle_frame}) um \todo{seine Präsenz zu beteuern}.
