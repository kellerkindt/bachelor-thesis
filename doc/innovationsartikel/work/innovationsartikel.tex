...
{../tmp/WatzkoMichael/rustacean-flat-happy.png}
  \captionof{figure}{\fontspec{Lucida Sans} \footnotesize Inoffizielles Maskottchen der Programmiersprache Rust}
  \end{center}
  \end{minipage}
 \end{center}
}
...
{../tmp/WatzkoMichael/MECView_Schaubild_BoschStyle_V2.png}
  \captionof{figure}{\fontspec{Lucida Sans} \footnotesize MEC-View-Schaubild der Robert Bosh GmbH}
  \end{center}
  \end{minipage}
 \end{center}
}
