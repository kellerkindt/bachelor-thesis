...
Durch die Lebenszeitanalyse \todo{ref} in Rust ist der Scope der \rustcinline{File} Variable bekannt, weshalb in dem Rust Beispiel in \autoref{rust:result:rust_good_fopen} die Datei auch wieder ordnungsgemäß geschlossen, während dies im C Beispiel in \autoref{rust:result:c_bad_fopen} nicht der Fall ist.
