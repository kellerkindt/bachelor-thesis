...
Der \rustcinline{Vec} der Standardbibliothek (siehe \autoref{rust:std}) bietet zusätzlich \rustcinline{Vec::with_capacity(capacity: usize)} an um einen Vektor mit einer bestimmten Größe zu initialisieren.
...
\todo{Drop, Sized, Sync, Send, Copy, Clone, Debug, Display, Default, Derive}
