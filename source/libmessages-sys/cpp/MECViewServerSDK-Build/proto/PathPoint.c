...
static int
memb_probybility_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_probybility_constr_3 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 8,  8,  0,  200 }	/* (0..200) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_PathPoint_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PathPoint, position_offset),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PathPoint, probybility),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		memb_probybility_constraint_1,
		&asn_PER_memb_probybility_constr_3,
		0,
		"probybility"
		},
};
...
static const asn_TYPE_tag2member_t asn_MAP_PathPoint_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* position-offset */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* probybility */
};
