...
fn bindgen_test_layout_Header() {
    assert_eq!(::std::mem::size_of::<Header>() , 32usize , concat ! (
               "Size of: " , stringify ! ( Header ) ));
    assert_eq! (::std::mem::align_of::<Header>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( Header ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Header ) ) . timestamp as * const _ as
                usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( Header ) , "::" ,
                stringify ! ( timestamp ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Header ) ) . _asn_ctx as * const _ as
                usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( Header ) , "::" ,
                stringify ! ( _asn_ctx ) ));
}
...
fn bindgen_test_layout_ReferencePoint() {
    assert_eq!(::std::mem::size_of::<ReferencePoint>() , 48usize , concat ! (
               "Size of: " , stringify ! ( ReferencePoint ) ));
    assert_eq! (::std::mem::align_of::<ReferencePoint>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( ReferencePoint ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const ReferencePoint ) ) . latitude as * const
                _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( ReferencePoint ) , "::"
                , stringify ! ( latitude ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const ReferencePoint ) ) . longitude as * const
                _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( ReferencePoint ) , "::"
                , stringify ! ( longitude ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const ReferencePoint ) ) . altitude as * const
                _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( ReferencePoint ) , "::"
                , stringify ! ( altitude ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const ReferencePoint ) ) . _asn_ctx as * const
                _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( ReferencePoint ) , "::"
                , stringify ! ( _asn_ctx ) ));
}
...
extern "C" {
    #[link_name = "asn_DEF_ReferencePoint"]
...
fn bindgen_test_layout_MovingVector() {
    assert_eq!(::std::mem::size_of::<MovingVector>() , 56usize , concat ! (
               "Size of: " , stringify ! ( MovingVector ) ));
    assert_eq! (::std::mem::align_of::<MovingVector>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( MovingVector ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const MovingVector ) ) . velocity_north as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( MovingVector ) , "::" ,
                stringify ! ( velocity_north ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const MovingVector ) ) . velocity_east as *
                const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( MovingVector ) , "::" ,
                stringify ! ( velocity_east ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const MovingVector ) ) . std_dev_velocity_north
                as * const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( MovingVector ) , "::" ,
                stringify ! ( std_dev_velocity_north ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const MovingVector ) ) . std_dev_velocity_east
                as * const _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( MovingVector ) , "::" ,
                stringify ! ( std_dev_velocity_east ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const MovingVector ) ) . _asn_ctx as * const _
                as usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! ( MovingVector ) , "::" ,
                stringify ! ( _asn_ctx ) ));
}
impl Clone for MovingVector {
    fn clone(&self) -> Self { *self }
}
pub type MovingVector_t = MovingVector;
extern "C" {
    #[link_name = "asn_DEF_MovingVector"]
...
fn bindgen_test_layout_ObjectSize() {
    assert_eq!(::std::mem::size_of::<ObjectSize>() , 72usize , concat ! (
               "Size of: " , stringify ! ( ObjectSize ) ));
    assert_eq! (::std::mem::align_of::<ObjectSize>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( ObjectSize ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const ObjectSize ) ) . length as * const _ as
                usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( ObjectSize ) , "::" ,
                stringify ! ( length ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const ObjectSize ) ) . width as * const _ as
                usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( ObjectSize ) , "::" ,
                stringify ! ( width ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const ObjectSize ) ) . height as * const _ as
                usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( ObjectSize ) , "::" ,
                stringify ! ( height ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const ObjectSize ) ) . std_dev_length as *
                const _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( ObjectSize ) , "::" ,
                stringify ! ( std_dev_length ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const ObjectSize ) ) . std_dev_width as * const
                _ as usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! ( ObjectSize ) , "::" ,
                stringify ! ( std_dev_width ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const ObjectSize ) ) . std_dev_height as *
                const _ as usize } , 40usize , concat ! (
                "Alignment of field: " , stringify ! ( ObjectSize ) , "::" ,
                stringify ! ( std_dev_height ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const ObjectSize ) ) . _asn_ctx as * const _ as
                usize } , 48usize , concat ! (
                "Alignment of field: " , stringify ! ( ObjectSize ) , "::" ,
                stringify ! ( _asn_ctx ) ));
}
...
extern "C" {
    pub fn NativeEnumerated_decode_uper(opt_codec_ctx: *mut asn_codec_ctx_t,
                                        type_descriptor:
                                            *mut asn_TYPE_descriptor_s,
                                        constraints:
                                            *mut asn_per_constraints_t,
...
extern "C" {
    pub fn NativeEnumerated_encode_uper(type_descriptor:
                                            *mut asn_TYPE_descriptor_s,
                                        constraints:
                                            *mut asn_per_constraints_t,
                                        struct_ptr:
...
extern "C" {
    #[link_name = "asn_DEF_ObjectType"]
    pub static mut asn_DEF_ObjectType: asn_TYPE_descriptor_t;
}
extern "C" {
    pub fn ObjectType_free(type_descriptor: *mut asn_TYPE_descriptor_s,
                           struct_ptr: *mut ::std::os::raw::c_void,
                           free_contents_only: ::std::os::raw::c_int);
}
extern "C" {
    pub fn ObjectType_print(type_descriptor: *mut asn_TYPE_descriptor_s,
                            struct_ptr: *const ::std::os::raw::c_void,
                            level: ::std::os::raw::c_int,
                            callback: asn_app_consume_bytes_f,
                            app_key: *mut ::std::os::raw::c_void)
...
extern "C" {
    pub fn ObjectType_constraint(type_descriptor: *mut asn_TYPE_descriptor_s,
                                 struct_ptr: *const ::std::os::raw::c_void,
                                 optional_callback:
                                     asn_app_constraint_failed_f,
                                 optional_app_key:
...
extern "C" {
    pub fn ObjectType_decode_ber(opt_codec_ctx: *mut asn_codec_ctx_s,
                                 type_descriptor: *mut asn_TYPE_descriptor_s,
                                 struct_ptr: *mut *mut ::std::os::raw::c_void,
                                 buf_ptr: *const ::std::os::raw::c_void,
                                 size: usize, tag_mode: ::std::os::raw::c_int)
...
extern "C" {
    pub fn ObjectType_encode_der(type_descriptor: *mut asn_TYPE_descriptor_s,
                                 struct_ptr: *mut ::std::os::raw::c_void,
                                 tag_mode: ::std::os::raw::c_int,
                                 tag: ber_tlv_tag_t,
                                 consume_bytes_cb: asn_app_consume_bytes_f,
...
extern "C" {
    pub fn ObjectType_decode_xer(opt_codec_ctx: *mut asn_codec_ctx_t,
                                 type_descriptor: *mut asn_TYPE_descriptor_s,
                                 struct_ptr: *mut *mut ::std::os::raw::c_void,
                                 opt_mname: *const ::std::os::raw::c_char,
                                 buf_ptr: *const ::std::os::raw::c_void,
...
extern "C" {
    pub fn ObjectType_encode_xer(type_descriptor: *mut asn_TYPE_descriptor_s,
                                 struct_ptr: *mut ::std::os::raw::c_void,
                                 ilevel: ::std::os::raw::c_int,
                                 xer_flags: xer_encoder_flags_e,
                                 consume_bytes_cb: asn_app_consume_bytes_f,
...
extern "C" {
    pub fn ObjectType_decode_uper(opt_codec_ctx: *mut asn_codec_ctx_t,
                                  type_descriptor: *mut asn_TYPE_descriptor_s,
                                  constraints: *mut asn_per_constraints_t,
                                  struct_ptr:
                                      *mut *mut ::std::os::raw::c_void,
...
extern "C" {
    pub fn ObjectType_encode_uper(type_descriptor: *mut asn_TYPE_descriptor_s,
                                  constraints: *mut asn_per_constraints_t,
                                  struct_ptr: *mut ::std::os::raw::c_void,
                                  per_output: *mut asn_per_outp_t)
     -> asn_enc_rval_t;
...
fn bindgen_test_layout_Covariance() {
    assert_eq!(::std::mem::size_of::<Covariance>() , 72usize , concat ! (
               "Size of: " , stringify ! ( Covariance ) ));
    assert_eq! (::std::mem::align_of::<Covariance>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( Covariance ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Covariance ) ) . north_pos_east_pos as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( Covariance ) , "::" ,
                stringify ! ( north_pos_east_pos ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Covariance ) ) . north_pos_north_vel as *
                const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( Covariance ) , "::" ,
                stringify ! ( north_pos_north_vel ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Covariance ) ) . north_pos_east_vel as *
                const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( Covariance ) , "::" ,
                stringify ! ( north_pos_east_vel ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Covariance ) ) . east_pos_north_vel as *
                const _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( Covariance ) , "::" ,
                stringify ! ( east_pos_north_vel ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Covariance ) ) . east_pos_east_vel as *
                const _ as usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! ( Covariance ) , "::" ,
                stringify ! ( east_pos_east_vel ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Covariance ) ) . north_vel_east_vel as *
                const _ as usize } , 40usize , concat ! (
                "Alignment of field: " , stringify ! ( Covariance ) , "::" ,
                stringify ! ( north_vel_east_vel ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Covariance ) ) . _asn_ctx as * const _ as
                usize } , 48usize , concat ! (
                "Alignment of field: " , stringify ! ( Covariance ) , "::" ,
                stringify ! ( _asn_ctx ) ));
}
...
pub struct PathPoint {
    ...
    pub probybility: ::std::os::raw::c_long,
    pub _asn_ctx: asn_struct_ctx_t,
}
#[test]
fn bindgen_test_layout_PathPoint() {
    assert_eq!(::std::mem::size_of::<PathPoint>() , 88usize , concat ! (
               "Size of: " , stringify ! ( PathPoint ) ));
    assert_eq! (::std::mem::align_of::<PathPoint>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( PathPoint ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const PathPoint ) ) . position_offset as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( PathPoint ) , "::" ,
                stringify ! ( position_offset ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const PathPoint ) ) . probybility as * const _
                as usize } , 56usize , concat ! (
                "Alignment of field: " , stringify ! ( PathPoint ) , "::" ,
                stringify ! ( probybility ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const PathPoint ) ) . _asn_ctx as * const _ as
...
extern "C" {
    #[link_name = "asn_DEF_PathPoint"]
    pub static mut asn_DEF_PathPoint: asn_TYPE_descriptor_t;
}
extern "C" {
    pub fn asn_set_add(asn_set_of_x: *mut ::std::os::raw::c_void,
                       ptr: *mut ::std::os::raw::c_void)
     -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn asn_set_del(asn_set_of_x: *mut ::std::os::raw::c_void,
...
fn bindgen_test_layout_asn_anonymous_set_() {
    assert_eq!(::std::mem::size_of::<asn_anonymous_set_>() , 24usize , concat
               ! ( "Size of: " , stringify ! ( asn_anonymous_set_ ) ));
    assert_eq! (::std::mem::align_of::<asn_anonymous_set_>() , 8usize , concat
                ! ( "Alignment of " , stringify ! ( asn_anonymous_set_ ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const asn_anonymous_set_ ) ) . array as * const
                _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( asn_anonymous_set_ ) ,
                "::" , stringify ! ( array ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const asn_anonymous_set_ ) ) . count as * const
                _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( asn_anonymous_set_ ) ,
                "::" , stringify ! ( count ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const asn_anonymous_set_ ) ) . size as * const
                _ as usize } , 12usize , concat ! (
                "Alignment of field: " , stringify ! ( asn_anonymous_set_ ) ,
                "::" , stringify ! ( size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const asn_anonymous_set_ ) ) . free as * const
                _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( asn_anonymous_set_ ) ,
                "::" , stringify ! ( free ) ));
}
impl Clone for asn_anonymous_set_ {
    fn clone(&self) -> Self { *self }
}
extern "C" {
    pub fn asn_sequence_del(asn_sequence_of_x: *mut ::std::os::raw::c_void,
                            number: ::std::os::raw::c_int,
                            _do_free: ::std::os::raw::c_int);
}
#[repr(C)]
...
fn bindgen_test_layout_asn_anonymous_sequence_() {
    assert_eq!(::std::mem::size_of::<asn_anonymous_sequence_>() , 24usize ,
               concat ! (
               "Size of: " , stringify ! ( asn_anonymous_sequence_ ) ));
    assert_eq! (::std::mem::align_of::<asn_anonymous_sequence_>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( asn_anonymous_sequence_ ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const asn_anonymous_sequence_ ) ) . array as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( asn_anonymous_sequence_
                ) , "::" , stringify ! ( array ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const asn_anonymous_sequence_ ) ) . count as *
                const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( asn_anonymous_sequence_
                ) , "::" , stringify ! ( count ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const asn_anonymous_sequence_ ) ) . size as *
                const _ as usize } , 12usize , concat ! (
                "Alignment of field: " , stringify ! ( asn_anonymous_sequence_
                ) , "::" , stringify ! ( size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const asn_anonymous_sequence_ ) ) . free as *
                const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( asn_anonymous_sequence_
                ) , "::" , stringify ! ( free ) ));
}
impl Clone for asn_anonymous_sequence_ {
    fn clone(&self) -> Self { *self }
}
#[repr(C)]
#[derive(Debug, Copy)]
...
fn bindgen_test_layout_asn_SET_OF_specifics_s() {
    assert_eq!(::std::mem::size_of::<asn_SET_OF_specifics_s>() , 12usize ,
               concat ! ( "Size of: " , stringify ! ( asn_SET_OF_specifics_s )
               ));
    assert_eq! (::std::mem::align_of::<asn_SET_OF_specifics_s>() , 4usize ,
                concat ! (
                "Alignment of " , stringify ! ( asn_SET_OF_specifics_s ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const asn_SET_OF_specifics_s ) ) . struct_size
                as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( asn_SET_OF_specifics_s
                ) , "::" , stringify ! ( struct_size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const asn_SET_OF_specifics_s ) ) . ctx_offset
                as * const _ as usize } , 4usize , concat ! (
                "Alignment of field: " , stringify ! ( asn_SET_OF_specifics_s
                ) , "::" , stringify ! ( ctx_offset ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const asn_SET_OF_specifics_s ) ) .
                as_XMLValueList as * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( asn_SET_OF_specifics_s
                ) , "::" , stringify ! ( as_XMLValueList ) ));
}
impl Clone for asn_SET_OF_specifics_s {
    fn clone(&self) -> Self { *self }
}
pub type asn_SET_OF_specifics_t = asn_SET_OF_specifics_s;
extern "C" {
    pub fn SET_OF_free(type_descriptor: *mut asn_TYPE_descriptor_s,
                       struct_ptr: *mut ::std::os::raw::c_void,
                       free_contents_only: ::std::os::raw::c_int);
}
extern "C" {
    pub fn SET_OF_print(type_descriptor: *mut asn_TYPE_descriptor_s,
                        struct_ptr: *const ::std::os::raw::c_void,
                        level: ::std::os::raw::c_int,
                        callback: asn_app_consume_bytes_f,
                        app_key: *mut ::std::os::raw::c_void)
...
extern "C" {
    pub fn SET_OF_constraint(type_descriptor: *mut asn_TYPE_descriptor_s,
                             struct_ptr: *const ::std::os::raw::c_void,
                             optional_callback: asn_app_constraint_failed_f,
                             optional_app_key: *mut ::std::os::raw::c_void)
     -> ::std::os::raw::c_int;
...
extern "C" {
    pub fn SET_OF_decode_ber(opt_codec_ctx: *mut asn_codec_ctx_s,
                             type_descriptor: *mut asn_TYPE_descriptor_s,
                             struct_ptr: *mut *mut ::std::os::raw::c_void,
                             buf_ptr: *const ::std::os::raw::c_void,
                             size: usize, tag_mode: ::std::os::raw::c_int)
...
extern "C" {
    pub fn SET_OF_encode_der(type_descriptor: *mut asn_TYPE_descriptor_s,
                             struct_ptr: *mut ::std::os::raw::c_void,
                             tag_mode: ::std::os::raw::c_int,
                             tag: ber_tlv_tag_t,
                             consume_bytes_cb: asn_app_consume_bytes_f,
...
extern "C" {
    pub fn SET_OF_decode_xer(opt_codec_ctx: *mut asn_codec_ctx_t,
                             type_descriptor: *mut asn_TYPE_descriptor_s,
                             struct_ptr: *mut *mut ::std::os::raw::c_void,
                             opt_mname: *const ::std::os::raw::c_char,
                             buf_ptr: *const ::std::os::raw::c_void,
...
extern "C" {
    pub fn SET_OF_encode_xer(type_descriptor: *mut asn_TYPE_descriptor_s,
                             struct_ptr: *mut ::std::os::raw::c_void,
                             ilevel: ::std::os::raw::c_int,
                             xer_flags: xer_encoder_flags_e,
                             consume_bytes_cb: asn_app_consume_bytes_f,
...
extern "C" {
    pub fn SET_OF_decode_uper(opt_codec_ctx: *mut asn_codec_ctx_t,
                              type_descriptor: *mut asn_TYPE_descriptor_s,
                              constraints: *mut asn_per_constraints_t,
                              struct_ptr: *mut *mut ::std::os::raw::c_void,
                              per_data: *mut asn_per_data_t)
...
extern "C" {
    pub fn SET_OF_encode_uper(type_descriptor: *mut asn_TYPE_descriptor_s,
                              constraints: *mut asn_per_constraints_t,
                              struct_ptr: *mut ::std::os::raw::c_void,
                              per_output: *mut asn_per_outp_t)
     -> asn_enc_rval_t;
...
extern "C" {
    pub fn SEQUENCE_OF_encode_der(type_descriptor: *mut asn_TYPE_descriptor_s,
                                  struct_ptr: *mut ::std::os::raw::c_void,
                                  tag_mode: ::std::os::raw::c_int,
                                  tag: ber_tlv_tag_t,
                                  consume_bytes_cb: asn_app_consume_bytes_f,
...
extern "C" {
    pub fn SEQUENCE_OF_encode_xer(type_descriptor: *mut asn_TYPE_descriptor_s,
                                  struct_ptr: *mut ::std::os::raw::c_void,
                                  ilevel: ::std::os::raw::c_int,
                                  xer_flags: xer_encoder_flags_e,
                                  consume_bytes_cb: asn_app_consume_bytes_f,
...
extern "C" {
    pub fn SEQUENCE_OF_encode_uper(type_descriptor:
                                       *mut asn_TYPE_descriptor_s,
                                   constraints: *mut asn_per_constraints_t,
                                   struct_ptr: *mut ::std::os::raw::c_void,
                                   per_output: *mut asn_per_outp_t)
...
fn bindgen_test_layout_Path__bindgen_ty_1() {
    assert_eq!(::std::mem::size_of::<Path__bindgen_ty_1>() , 24usize , concat
               ! ( "Size of: " , stringify ! ( Path__bindgen_ty_1 ) ));
    assert_eq! (::std::mem::align_of::<Path__bindgen_ty_1>() , 8usize , concat
                ! ( "Alignment of " , stringify ! ( Path__bindgen_ty_1 ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Path__bindgen_ty_1 ) ) . array as * const
                _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( Path__bindgen_ty_1 ) ,
                "::" , stringify ! ( array ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Path__bindgen_ty_1 ) ) . count as * const
                _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( Path__bindgen_ty_1 ) ,
                "::" , stringify ! ( count ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Path__bindgen_ty_1 ) ) . size as * const
                _ as usize } , 12usize , concat ! (
                "Alignment of field: " , stringify ! ( Path__bindgen_ty_1 ) ,
                "::" , stringify ! ( size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Path__bindgen_ty_1 ) ) . free as * const
                _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( Path__bindgen_ty_1 ) ,
                "::" , stringify ! ( free ) ));
}
impl Clone for Path__bindgen_ty_1 {
    fn clone(&self) -> Self { *self }
}
#[test]
fn bindgen_test_layout_Path() {
    assert_eq!(::std::mem::size_of::<Path>() , 48usize , concat ! (
               "Size of: " , stringify ! ( Path ) ));
    assert_eq! (::std::mem::align_of::<Path>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( Path ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Path ) ) . list as * const _ as usize } ,
                0usize , concat ! (
                "Alignment of field: " , stringify ! ( Path ) , "::" ,
                stringify ! ( list ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Path ) ) . _asn_ctx as * const _ as usize
                } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( Path ) , "::" ,
                stringify ! ( _asn_ctx ) ));
}
...
fn bindgen_test_layout_PredictedPath() {
    assert_eq!(::std::mem::size_of::<PredictedPath>() , 80usize , concat ! (
               "Size of: " , stringify ! ( PredictedPath ) ));
    assert_eq! (::std::mem::align_of::<PredictedPath>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( PredictedPath ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const PredictedPath ) ) . timestamp_dt as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( PredictedPath ) , "::"
                , stringify ! ( timestamp_dt ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const PredictedPath ) ) . path as * const _ as
                usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( PredictedPath ) , "::"
                , stringify ! ( path ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const PredictedPath ) ) . _asn_ctx as * const _
                as usize } , 56usize , concat ! (
                "Alignment of field: " , stringify ! ( PredictedPath ) , "::"
                , stringify ! ( _asn_ctx ) ));
}
...
extern "C" {
    #[link_name = "asn_DEF_PredictedPath"]
...
fn bindgen_test_layout_SectorIds__bindgen_ty_1() {
    assert_eq!(::std::mem::size_of::<SectorIds__bindgen_ty_1>() , 24usize ,
               concat ! (
               "Size of: " , stringify ! ( SectorIds__bindgen_ty_1 ) ));
    assert_eq! (::std::mem::align_of::<SectorIds__bindgen_ty_1>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( SectorIds__bindgen_ty_1 ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SectorIds__bindgen_ty_1 ) ) . array as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( SectorIds__bindgen_ty_1
                ) , "::" , stringify ! ( array ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SectorIds__bindgen_ty_1 ) ) . count as *
                const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( SectorIds__bindgen_ty_1
                ) , "::" , stringify ! ( count ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SectorIds__bindgen_ty_1 ) ) . size as *
                const _ as usize } , 12usize , concat ! (
                "Alignment of field: " , stringify ! ( SectorIds__bindgen_ty_1
                ) , "::" , stringify ! ( size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SectorIds__bindgen_ty_1 ) ) . free as *
                const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( SectorIds__bindgen_ty_1
                ) , "::" , stringify ! ( free ) ));
}
impl Clone for SectorIds__bindgen_ty_1 {
    fn clone(&self) -> Self { *self }
}
#[test]
fn bindgen_test_layout_SectorIds() {
    assert_eq!(::std::mem::size_of::<SectorIds>() , 48usize , concat ! (
               "Size of: " , stringify ! ( SectorIds ) ));
    assert_eq! (::std::mem::align_of::<SectorIds>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( SectorIds ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SectorIds ) ) . list as * const _ as
                usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( SectorIds ) , "::" ,
                stringify ! ( list ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SectorIds ) ) . _asn_ctx as * const _ as
                usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( SectorIds ) , "::" ,
                stringify ! ( _asn_ctx ) ));
}
impl Clone for SectorIds {
    fn clone(&self) -> Self { *self }
}
pub type SectorIds_t = SectorIds;
extern "C" {
    #[link_name = "asn_DEF_SectorIds"]
...
fn bindgen_test_layout_Error() {
    assert_eq!(::std::mem::size_of::<Error>() , 80usize , concat ! (
               "Size of: " , stringify ! ( Error ) ));
    assert_eq! (::std::mem::align_of::<Error>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( Error ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Error ) ) . id as * const _ as usize } ,
                0usize , concat ! (
                "Alignment of field: " , stringify ! ( Error ) , "::" ,
                stringify ! ( id ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Error ) ) . sector_ids as * const _ as
                usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( Error ) , "::" ,
                stringify ! ( sector_ids ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Error ) ) . _asn_ctx as * const _ as
...
fn bindgen_test_layout_Errors__bindgen_ty_1() {
    assert_eq!(::std::mem::size_of::<Errors__bindgen_ty_1>() , 24usize ,
               concat ! ( "Size of: " , stringify ! ( Errors__bindgen_ty_1 )
               ));
    assert_eq! (::std::mem::align_of::<Errors__bindgen_ty_1>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( Errors__bindgen_ty_1 ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Errors__bindgen_ty_1 ) ) . array as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( Errors__bindgen_ty_1 )
                , "::" , stringify ! ( array ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Errors__bindgen_ty_1 ) ) . count as *
                const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( Errors__bindgen_ty_1 )
                , "::" , stringify ! ( count ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Errors__bindgen_ty_1 ) ) . size as *
                const _ as usize } , 12usize , concat ! (
                "Alignment of field: " , stringify ! ( Errors__bindgen_ty_1 )
                , "::" , stringify ! ( size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Errors__bindgen_ty_1 ) ) . free as *
                const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( Errors__bindgen_ty_1 )
                , "::" , stringify ! ( free ) ));
}
impl Clone for Errors__bindgen_ty_1 {
    fn clone(&self) -> Self { *self }
}
#[test]
fn bindgen_test_layout_Errors() {
    assert_eq!(::std::mem::size_of::<Errors>() , 48usize , concat ! (
               "Size of: " , stringify ! ( Errors ) ));
    assert_eq! (::std::mem::align_of::<Errors>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( Errors ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Errors ) ) . list as * const _ as usize }
                , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( Errors ) , "::" ,
                stringify ! ( list ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Errors ) ) . _asn_ctx as * const _ as
                usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( Errors ) , "::" ,
                stringify ! ( _asn_ctx ) ));
}
...
fn bindgen_test_layout_EnvironmentEnvelope() {
    assert_eq!(::std::mem::size_of::<EnvironmentEnvelope>() , 136usize ,
               concat ! ( "Size of: " , stringify ! ( EnvironmentEnvelope )
               ));
    assert_eq! (::std::mem::align_of::<EnvironmentEnvelope>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( EnvironmentEnvelope ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const EnvironmentEnvelope ) ) . version as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( EnvironmentEnvelope ) ,
                "::" , stringify ! ( version ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const EnvironmentEnvelope ) ) . server_id as *
                const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( EnvironmentEnvelope ) ,
                "::" , stringify ! ( server_id ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const EnvironmentEnvelope ) ) . reference_point
                as * const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( EnvironmentEnvelope ) ,
                "::" , stringify ! ( reference_point ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const EnvironmentEnvelope ) ) . error_codes as
                * const _ as usize } , 64usize , concat ! (
                "Alignment of field: " , stringify ! ( EnvironmentEnvelope ) ,
                "::" , stringify ! ( error_codes ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const EnvironmentEnvelope ) ) . _asn_ctx as *
                const _ as usize } , 112usize , concat ! (
                "Alignment of field: " , stringify ! ( EnvironmentEnvelope ) ,
                "::" , stringify ! ( _asn_ctx ) ));
}
impl Clone for EnvironmentEnvelope {
    fn clone(&self) -> Self { *self }
}
pub type EnvironmentEnvelope_t = EnvironmentEnvelope;
extern "C" {
    #[link_name = "asn_DEF_EnvironmentEnvelope"]
    pub static mut asn_DEF_EnvironmentEnvelope: asn_TYPE_descriptor_t;
}
pub type BOOLEAN_t = ::std::os::raw::c_int;
extern "C" {
    #[link_name = "asn_DEF_BOOLEAN"]
    pub static mut asn_DEF_BOOLEAN: asn_TYPE_descriptor_t;
}
extern "C" {
    pub fn BOOLEAN_free(type_descriptor: *mut asn_TYPE_descriptor_s,
                        struct_ptr: *mut ::std::os::raw::c_void,
                        free_contents_only: ::std::os::raw::c_int);
}
extern "C" {
    pub fn BOOLEAN_print(type_descriptor: *mut asn_TYPE_descriptor_s,
                         struct_ptr: *const ::std::os::raw::c_void,
                         level: ::std::os::raw::c_int,
                         callback: asn_app_consume_bytes_f,
                         app_key: *mut ::std::os::raw::c_void)
...
extern "C" {
    pub fn BOOLEAN_decode_ber(opt_codec_ctx: *mut asn_codec_ctx_s,
                              type_descriptor: *mut asn_TYPE_descriptor_s,
                              struct_ptr: *mut *mut ::std::os::raw::c_void,
                              buf_ptr: *const ::std::os::raw::c_void,
                              size: usize, tag_mode: ::std::os::raw::c_int)
...
extern "C" {
    pub fn BOOLEAN_encode_der(type_descriptor: *mut asn_TYPE_descriptor_s,
                              struct_ptr: *mut ::std::os::raw::c_void,
                              tag_mode: ::std::os::raw::c_int,
                              tag: ber_tlv_tag_t,
                              consume_bytes_cb: asn_app_consume_bytes_f,
...
extern "C" {
    pub fn BOOLEAN_decode_xer(opt_codec_ctx: *mut asn_codec_ctx_t,
                              type_descriptor: *mut asn_TYPE_descriptor_s,
                              struct_ptr: *mut *mut ::std::os::raw::c_void,
                              opt_mname: *const ::std::os::raw::c_char,
                              buf_ptr: *const ::std::os::raw::c_void,
...
extern "C" {
    pub fn BOOLEAN_encode_xer(type_descriptor: *mut asn_TYPE_descriptor_s,
                              struct_ptr: *mut ::std::os::raw::c_void,
                              ilevel: ::std::os::raw::c_int,
                              xer_flags: xer_encoder_flags_e,
                              consume_bytes_cb: asn_app_consume_bytes_f,
...
extern "C" {
    pub fn BOOLEAN_decode_uper(opt_codec_ctx: *mut asn_codec_ctx_t,
                               type_descriptor: *mut asn_TYPE_descriptor_s,
                               constraints: *mut asn_per_constraints_t,
                               struct_ptr: *mut *mut ::std::os::raw::c_void,
                               per_data: *mut asn_per_data_t)
...
extern "C" {
    pub fn BOOLEAN_encode_uper(type_descriptor: *mut asn_TYPE_descriptor_s,
                               constraints: *mut asn_per_constraints_t,
                               struct_ptr: *mut ::std::os::raw::c_void,
                               per_output: *mut asn_per_outp_t)
     -> asn_enc_rval_t;
...
fn bindgen_test_layout_EnvironmentObjectDetection() {
    assert_eq!(::std::mem::size_of::<EnvironmentObjectDetection>() , 376usize
               , concat ! (
               "Size of: " , stringify ! ( EnvironmentObjectDetection ) ));
    assert_eq! (::std::mem::align_of::<EnvironmentObjectDetection>() , 8usize
                , concat ! (
                "Alignment of " , stringify ! ( EnvironmentObjectDetection )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const EnvironmentObjectDetection ) ) .
                timestamp as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                EnvironmentObjectDetection ) , "::" , stringify ! ( timestamp
                ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const EnvironmentObjectDetection ) ) . measured
                as * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! (
                EnvironmentObjectDetection ) , "::" , stringify ! ( measured )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const EnvironmentObjectDetection ) ) .
                global_id as * const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! (
                EnvironmentObjectDetection ) , "::" , stringify ! ( global_id
                ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const EnvironmentObjectDetection ) ) .
                probability_of_existence as * const _ as usize } , 24usize ,
                concat ! (
                "Alignment of field: " , stringify ! (
                EnvironmentObjectDetection ) , "::" , stringify ! (
                probability_of_existence ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const EnvironmentObjectDetection ) ) .
                position_offset as * const _ as usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! (
                EnvironmentObjectDetection ) , "::" , stringify ! (
                position_offset ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const EnvironmentObjectDetection ) ) .
                moving_vector as * const _ as usize } , 88usize , concat ! (
                "Alignment of field: " , stringify ! (
                EnvironmentObjectDetection ) , "::" , stringify ! (
                moving_vector ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const EnvironmentObjectDetection ) ) . type_ as
                * const _ as usize } , 96usize , concat ! (
                "Alignment of field: " , stringify ! (
                EnvironmentObjectDetection ) , "::" , stringify ! ( type_ )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const EnvironmentObjectDetection ) ) .
                type_probability as * const _ as usize } , 104usize , concat !
                (
                "Alignment of field: " , stringify ! (
                EnvironmentObjectDetection ) , "::" , stringify ! (
                type_probability ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const EnvironmentObjectDetection ) ) . size as
                * const _ as usize } , 112usize , concat ! (
                "Alignment of field: " , stringify ! (
                EnvironmentObjectDetection ) , "::" , stringify ! ( size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const EnvironmentObjectDetection ) ) .
                covariance as * const _ as usize } , 184usize , concat ! (
                "Alignment of field: " , stringify ! (
                EnvironmentObjectDetection ) , "::" , stringify ! ( covariance
                ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const EnvironmentObjectDetection ) ) .
                orientation as * const _ as usize } , 256usize , concat ! (
                "Alignment of field: " , stringify ! (
                EnvironmentObjectDetection ) , "::" , stringify ! (
                orientation ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const EnvironmentObjectDetection ) ) .
                std_dev_orientation as * const _ as usize } , 264usize ,
                concat ! (
                "Alignment of field: " , stringify ! (
                EnvironmentObjectDetection ) , "::" , stringify ! (
                std_dev_orientation ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const EnvironmentObjectDetection ) ) .
                predicted_path as * const _ as usize } , 272usize , concat ! (
                "Alignment of field: " , stringify ! (
                EnvironmentObjectDetection ) , "::" , stringify ! (
                predicted_path ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const EnvironmentObjectDetection ) ) . _asn_ctx
                as * const _ as usize } , 352usize , concat ! (
                "Alignment of field: " , stringify ! (
                EnvironmentObjectDetection ) , "::" , stringify ! ( _asn_ctx )
                ));
}
impl Clone for EnvironmentObjectDetection {
    fn clone(&self) -> Self { *self }
}
pub type EnvironmentObjectDetection_t = EnvironmentObjectDetection;
extern "C" {
    #[link_name = "asn_DEF_EnvironmentObjectDetection"]
...
pub struct EnvironmentObjectDetections__bindgen_ty_1 {
    ...
    pub size: ::std::os::raw::c_int,
    pub free: ::std::option::Option<unsafe extern "C" fn(arg1:
                                                             *mut EnvironmentObjectDetection)>,
}
#[test]
fn bindgen_test_layout_EnvironmentObjectDetections__bindgen_ty_1() {
    assert_eq!(::std::mem::size_of::<EnvironmentObjectDetections__bindgen_ty_1>()
               , 24usize , concat ! (
               "Size of: " , stringify ! (
               EnvironmentObjectDetections__bindgen_ty_1 ) ));
    assert_eq! (::std::mem::align_of::<EnvironmentObjectDetections__bindgen_ty_1>()
                , 8usize , concat ! (
                "Alignment of " , stringify ! (
                EnvironmentObjectDetections__bindgen_ty_1 ) ));
    assert_eq! (unsafe {
                & (
                * ( 0 as * const EnvironmentObjectDetections__bindgen_ty_1 ) )
                . array as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                EnvironmentObjectDetections__bindgen_ty_1 ) , "::" , stringify
                ! ( array ) ));
    assert_eq! (unsafe {
                & (
                * ( 0 as * const EnvironmentObjectDetections__bindgen_ty_1 ) )
    ...
    assert_eq! (unsafe {
                & (
                * ( 0 as * const EnvironmentObjectDetections__bindgen_ty_1 ) )
                . size as * const _ as usize } , 12usize , concat ! (
                "Alignment of field: " , stringify ! (
                EnvironmentObjectDetections__bindgen_ty_1 ) , "::" , stringify
                ! ( size ) ));
    assert_eq! (unsafe {
...
impl Clone for EnvironmentObjectDetections__bindgen_ty_1 {
    fn clone(&self) -> Self { *self }
}
#[test]
fn bindgen_test_layout_EnvironmentObjectDetections() {
    assert_eq!(::std::mem::size_of::<EnvironmentObjectDetections>() , 48usize
               , concat ! (
               "Size of: " , stringify ! ( EnvironmentObjectDetections ) ));
    assert_eq! (::std::mem::align_of::<EnvironmentObjectDetections>() , 8usize
                , concat ! (
                "Alignment of " , stringify ! ( EnvironmentObjectDetections )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const EnvironmentObjectDetections ) ) . list as
                * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                EnvironmentObjectDetections ) , "::" , stringify ! ( list )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const EnvironmentObjectDetections ) ) .
                _asn_ctx as * const _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! (
                EnvironmentObjectDetections ) , "::" , stringify ! ( _asn_ctx
                ) ));
}
impl Clone for EnvironmentObjectDetections {
    fn clone(&self) -> Self { *self }
}
pub type EnvironmentObjectDetections_t = EnvironmentObjectDetections;
extern "C" {
    #[link_name = "asn_DEF_EnvironmentObjectDetections"]
...
fn bindgen_test_layout_EnvironmentFrame() {
    assert_eq!(::std::mem::size_of::<EnvironmentFrame>() , 240usize , concat !
               ( "Size of: " , stringify ! ( EnvironmentFrame ) ));
    assert_eq! (::std::mem::align_of::<EnvironmentFrame>() , 8usize , concat !
                ( "Alignment of " , stringify ! ( EnvironmentFrame ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const EnvironmentFrame ) ) . header as * const
                _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( EnvironmentFrame ) ,
                "::" , stringify ! ( header ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const EnvironmentFrame ) ) . envelope as *
                const _ as usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! ( EnvironmentFrame ) ,
                "::" , stringify ! ( envelope ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const EnvironmentFrame ) ) . object_detections
                as * const _ as usize } , 168usize , concat ! (
                "Alignment of field: " , stringify ! ( EnvironmentFrame ) ,
                "::" , stringify ! ( object_detections ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const EnvironmentFrame ) ) . _asn_ctx as *
                const _ as usize } , 216usize , concat ! (
                "Alignment of field: " , stringify ! ( EnvironmentFrame ) ,
                "::" , stringify ! ( _asn_ctx ) ));
}
impl Clone for EnvironmentFrame {
    fn clone(&self) -> Self { *self }
}
pub type EnvironmentFrame_t = EnvironmentFrame;
extern "C" {
    #[link_name = "asn_DEF_EnvironmentFrame"]
...
fn bindgen_test_layout_Area__bindgen_ty_1() {
    assert_eq!(::std::mem::size_of::<Area__bindgen_ty_1>() , 24usize , concat
               ! ( "Size of: " , stringify ! ( Area__bindgen_ty_1 ) ));
    assert_eq! (::std::mem::align_of::<Area__bindgen_ty_1>() , 8usize , concat
                ! ( "Alignment of " , stringify ! ( Area__bindgen_ty_1 ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Area__bindgen_ty_1 ) ) . array as * const
                _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( Area__bindgen_ty_1 ) ,
                "::" , stringify ! ( array ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Area__bindgen_ty_1 ) ) . count as * const
                _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( Area__bindgen_ty_1 ) ,
                "::" , stringify ! ( count ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Area__bindgen_ty_1 ) ) . size as * const
                _ as usize } , 12usize , concat ! (
                "Alignment of field: " , stringify ! ( Area__bindgen_ty_1 ) ,
                "::" , stringify ! ( size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Area__bindgen_ty_1 ) ) . free as * const
                _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( Area__bindgen_ty_1 ) ,
                "::" , stringify ! ( free ) ));
}
impl Clone for Area__bindgen_ty_1 {
    fn clone(&self) -> Self { *self }
}
#[test]
fn bindgen_test_layout_Area() {
    assert_eq!(::std::mem::size_of::<Area>() , 48usize , concat ! (
               "Size of: " , stringify ! ( Area ) ));
    assert_eq! (::std::mem::align_of::<Area>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( Area ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Area ) ) . list as * const _ as usize } ,
                0usize , concat ! (
                "Alignment of field: " , stringify ! ( Area ) , "::" ,
                stringify ! ( list ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Area ) ) . _asn_ctx as * const _ as usize
                } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( Area ) , "::" ,
                stringify ! ( _asn_ctx ) ));
}
...
fn bindgen_test_layout_Sector() {
    assert_eq!(::std::mem::size_of::<Sector>() , 80usize , concat ! (
               "Size of: " , stringify ! ( Sector ) ));
    assert_eq! (::std::mem::align_of::<Sector>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( Sector ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Sector ) ) . id as * const _ as usize } ,
                0usize , concat ! (
                "Alignment of field: " , stringify ! ( Sector ) , "::" ,
                stringify ! ( id ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Sector ) ) . area as * const _ as usize }
                , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( Sector ) , "::" ,
                stringify ! ( area ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Sector ) ) . _asn_ctx as * const _ as
                usize } , 56usize , concat ! (
                "Alignment of field: " , stringify ! ( Sector ) , "::" ,
                stringify ! ( _asn_ctx ) ));
}
...
fn bindgen_test_layout_Sectors__bindgen_ty_1() {
    assert_eq!(::std::mem::size_of::<Sectors__bindgen_ty_1>() , 24usize ,
               concat ! ( "Size of: " , stringify ! ( Sectors__bindgen_ty_1 )
               ));
    assert_eq! (::std::mem::align_of::<Sectors__bindgen_ty_1>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( Sectors__bindgen_ty_1 ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Sectors__bindgen_ty_1 ) ) . array as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( Sectors__bindgen_ty_1 )
                , "::" , stringify ! ( array ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Sectors__bindgen_ty_1 ) ) . count as *
                const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( Sectors__bindgen_ty_1 )
                , "::" , stringify ! ( count ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Sectors__bindgen_ty_1 ) ) . size as *
                const _ as usize } , 12usize , concat ! (
                "Alignment of field: " , stringify ! ( Sectors__bindgen_ty_1 )
                , "::" , stringify ! ( size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Sectors__bindgen_ty_1 ) ) . free as *
                const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( Sectors__bindgen_ty_1 )
                , "::" , stringify ! ( free ) ));
}
impl Clone for Sectors__bindgen_ty_1 {
    fn clone(&self) -> Self { *self }
}
#[test]
fn bindgen_test_layout_Sectors() {
    assert_eq!(::std::mem::size_of::<Sectors>() , 48usize , concat ! (
               "Size of: " , stringify ! ( Sectors ) ));
    assert_eq! (::std::mem::align_of::<Sectors>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( Sectors ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Sectors ) ) . list as * const _ as usize
                } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( Sectors ) , "::" ,
                stringify ! ( list ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Sectors ) ) . _asn_ctx as * const _ as
                usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( Sectors ) , "::" ,
                stringify ! ( _asn_ctx ) ));
}
...
fn bindgen_test_layout_InitMessage() {
    assert_eq!(::std::mem::size_of::<InitMessage>() , 240usize , concat ! (
               "Size of: " , stringify ! ( InitMessage ) ));
    assert_eq! (::std::mem::align_of::<InitMessage>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( InitMessage ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const InitMessage ) ) . header as * const _ as
                usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( InitMessage ) , "::" ,
                stringify ! ( header ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const InitMessage ) ) . envelope as * const _
                as usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! ( InitMessage ) , "::" ,
                stringify ! ( envelope ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const InitMessage ) ) . sectors as * const _ as
                usize } , 168usize , concat ! (
                "Alignment of field: " , stringify ! ( InitMessage ) , "::" ,
                stringify ! ( sectors ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const InitMessage ) ) . _asn_ctx as * const _
...
fn bindgen_test_layout_RoadClearanceEnvelope() {
    assert_eq!(::std::mem::size_of::<RoadClearanceEnvelope>() , 88usize ,
               concat ! ( "Size of: " , stringify ! ( RoadClearanceEnvelope )
               ));
    assert_eq! (::std::mem::align_of::<RoadClearanceEnvelope>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( RoadClearanceEnvelope ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const RoadClearanceEnvelope ) ) . version as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( RoadClearanceEnvelope )
                , "::" , stringify ! ( version ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const RoadClearanceEnvelope ) ) . server_id as
                * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( RoadClearanceEnvelope )
                , "::" , stringify ! ( server_id ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const RoadClearanceEnvelope ) ) .
                reference_point as * const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( RoadClearanceEnvelope )
                , "::" , stringify ! ( reference_point ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const RoadClearanceEnvelope ) ) . _asn_ctx as *
                const _ as usize } , 64usize , concat ! (
                "Alignment of field: " , stringify ! ( RoadClearanceEnvelope )
                , "::" , stringify ! ( _asn_ctx ) ));
}
impl Clone for RoadClearanceEnvelope {
    fn clone(&self) -> Self { *self }
}
pub type RoadClearanceEnvelope_t = RoadClearanceEnvelope;
extern "C" {
    #[link_name = "asn_DEF_RoadClearanceEnvelope"]
...
fn bindgen_test_layout_OCTET_STRING() {
    assert_eq!(::std::mem::size_of::<OCTET_STRING>() , 40usize , concat ! (
               "Size of: " , stringify ! ( OCTET_STRING ) ));
    assert_eq! (::std::mem::align_of::<OCTET_STRING>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( OCTET_STRING ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const OCTET_STRING ) ) . buf as * const _ as
                usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( OCTET_STRING ) , "::" ,
                stringify ! ( buf ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const OCTET_STRING ) ) . size as * const _ as
                usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( OCTET_STRING ) , "::" ,
                stringify ! ( size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const OCTET_STRING ) ) . _asn_ctx as * const _
                as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( OCTET_STRING ) , "::" ,
                stringify ! ( _asn_ctx ) ));
}
...
extern "C" {
    #[link_name = "asn_DEF_OCTET_STRING"]
    pub static mut asn_DEF_OCTET_STRING: asn_TYPE_descriptor_t;
}
extern "C" {
    pub fn OCTET_STRING_free(type_descriptor: *mut asn_TYPE_descriptor_s,
                             struct_ptr: *mut ::std::os::raw::c_void,
                             free_contents_only: ::std::os::raw::c_int);
}
extern "C" {
    pub fn OCTET_STRING_print(type_descriptor: *mut asn_TYPE_descriptor_s,
                              struct_ptr: *const ::std::os::raw::c_void,
                              level: ::std::os::raw::c_int,
                              callback: asn_app_consume_bytes_f,
                              app_key: *mut ::std::os::raw::c_void)
...
extern "C" {
    pub fn OCTET_STRING_print_utf8(type_descriptor:
                                       *mut asn_TYPE_descriptor_s,
                                   struct_ptr: *const ::std::os::raw::c_void,
                                   level: ::std::os::raw::c_int,
                                   callback: asn_app_consume_bytes_f,
...
extern "C" {
    pub fn OCTET_STRING_decode_ber(opt_codec_ctx: *mut asn_codec_ctx_s,
                                   type_descriptor:
                                       *mut asn_TYPE_descriptor_s,
                                   struct_ptr:
                                       *mut *mut ::std::os::raw::c_void,
...
extern "C" {
    pub fn OCTET_STRING_encode_der(type_descriptor:
                                       *mut asn_TYPE_descriptor_s,
                                   struct_ptr: *mut ::std::os::raw::c_void,
                                   tag_mode: ::std::os::raw::c_int,
                                   tag: ber_tlv_tag_t,
...
extern "C" {
    pub fn OCTET_STRING_decode_xer_hex(opt_codec_ctx: *mut asn_codec_ctx_t,
                                       type_descriptor:
                                           *mut asn_TYPE_descriptor_s,
                                       struct_ptr:
                                           *mut *mut ::std::os::raw::c_void,
...
extern "C" {
    pub fn OCTET_STRING_decode_xer_binary(opt_codec_ctx: *mut asn_codec_ctx_t,
                                          type_descriptor:
                                              *mut asn_TYPE_descriptor_s,
                                          struct_ptr:
                                              *mut *mut ::std::os::raw::c_void,
...
extern "C" {
    pub fn OCTET_STRING_decode_xer_utf8(opt_codec_ctx: *mut asn_codec_ctx_t,
                                        type_descriptor:
                                            *mut asn_TYPE_descriptor_s,
                                        struct_ptr:
                                            *mut *mut ::std::os::raw::c_void,
...
extern "C" {
    pub fn OCTET_STRING_encode_xer(type_descriptor:
                                       *mut asn_TYPE_descriptor_s,
                                   struct_ptr: *mut ::std::os::raw::c_void,
                                   ilevel: ::std::os::raw::c_int,
                                   xer_flags: xer_encoder_flags_e,
...
extern "C" {
    pub fn OCTET_STRING_encode_xer_utf8(type_descriptor:
                                            *mut asn_TYPE_descriptor_s,
                                        struct_ptr:
                                            *mut ::std::os::raw::c_void,
                                        ilevel: ::std::os::raw::c_int,
...
extern "C" {
    pub fn OCTET_STRING_decode_uper(opt_codec_ctx: *mut asn_codec_ctx_t,
                                    type_descriptor:
                                        *mut asn_TYPE_descriptor_s,
                                    constraints: *mut asn_per_constraints_t,
                                    struct_ptr:
...
extern "C" {
    pub fn OCTET_STRING_encode_uper(type_descriptor:
                                        *mut asn_TYPE_descriptor_s,
                                    constraints: *mut asn_per_constraints_t,
                                    struct_ptr: *mut ::std::os::raw::c_void,
                                    per_output: *mut asn_per_outp_t)
...
extern "C" {
    pub fn OCTET_STRING_fromBuf(s: *mut OCTET_STRING_t,
                                str: *const ::std::os::raw::c_char,
                                size: ::std::os::raw::c_int)
     -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn OCTET_STRING_new_fromBuf(td: *mut asn_TYPE_descriptor_t,
                                    str: *const ::std::os::raw::c_char,
                                    size: ::std::os::raw::c_int)
     -> *mut OCTET_STRING_t;
}
...
#[repr(u32)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
pub enum asn_OCTET_STRING_specifics_s_asn_OS_Subvariant {
    ASN_OSUBV_ANY = 0,
    ASN_OSUBV_BIT = 1,
    ASN_OSUBV_STR = 2,
    ASN_OSUBV_U16 = 3,
...
fn bindgen_test_layout_asn_OCTET_STRING_specifics_s() {
    assert_eq!(::std::mem::size_of::<asn_OCTET_STRING_specifics_s>() , 12usize
               , concat ! (
               "Size of: " , stringify ! ( asn_OCTET_STRING_specifics_s ) ));
    assert_eq! (::std::mem::align_of::<asn_OCTET_STRING_specifics_s>() ,
                4usize , concat ! (
                "Alignment of " , stringify ! ( asn_OCTET_STRING_specifics_s )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const asn_OCTET_STRING_specifics_s ) ) .
                struct_size as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                asn_OCTET_STRING_specifics_s ) , "::" , stringify ! (
                struct_size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const asn_OCTET_STRING_specifics_s ) ) .
                ctx_offset as * const _ as usize } , 4usize , concat ! (
                "Alignment of field: " , stringify ! (
                asn_OCTET_STRING_specifics_s ) , "::" , stringify ! (
                ctx_offset ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const asn_OCTET_STRING_specifics_s ) ) .
                subvariant as * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! (
                asn_OCTET_STRING_specifics_s ) , "::" , stringify ! (
                subvariant ) ));
}
impl Clone for asn_OCTET_STRING_specifics_s {
    fn clone(&self) -> Self { *self }
}
pub type asn_OCTET_STRING_specifics_t = asn_OCTET_STRING_specifics_s;
pub type UTF8String_t = OCTET_STRING_t;
extern "C" {
    #[link_name = "asn_DEF_UTF8String"]
    pub static mut asn_DEF_UTF8String: asn_TYPE_descriptor_t;
}
extern "C" {
    pub fn UTF8String_print(type_descriptor: *mut asn_TYPE_descriptor_s,
                            struct_ptr: *const ::std::os::raw::c_void,
                            level: ::std::os::raw::c_int,
                            callback: asn_app_consume_bytes_f,
                            app_key: *mut ::std::os::raw::c_void)
...
extern "C" {
    pub fn UTF8String_constraint(type_descriptor: *mut asn_TYPE_descriptor_s,
                                 struct_ptr: *const ::std::os::raw::c_void,
                                 optional_callback:
                                     asn_app_constraint_failed_f,
                                 optional_app_key:
...
extern "C" {
    pub fn UTF8String_to_wcs(st: *const UTF8String_t, dst: *mut u32,
                             dstlen: usize) -> usize;
}
#[repr(C)]
#[derive(Debug, Copy)]
...
fn bindgen_test_layout_Parameter() {
    assert_eq!(::std::mem::size_of::<Parameter>() , 88usize , concat ! (
               "Size of: " , stringify ! ( Parameter ) ));
    assert_eq! (::std::mem::align_of::<Parameter>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( Parameter ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Parameter ) ) . id as * const _ as usize
                } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( Parameter ) , "::" ,
                stringify ! ( id ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Parameter ) ) . name as * const _ as
                usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( Parameter ) , "::" ,
                stringify ! ( name ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Parameter ) ) . value as * const _ as
                usize } , 48usize , concat ! (
                "Alignment of field: " , stringify ! ( Parameter ) , "::" ,
                stringify ! ( value ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Parameter ) ) . position as * const _ as
                usize } , 56usize , concat ! (
                "Alignment of field: " , stringify ! ( Parameter ) , "::" ,
                stringify ! ( position ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Parameter ) ) . _asn_ctx as * const _ as
                usize } , 64usize , concat ! (
                "Alignment of field: " , stringify ! ( Parameter ) , "::" ,
                stringify ! ( _asn_ctx ) ));
}
...
fn bindgen_test_layout_Parameters__bindgen_ty_1() {
    assert_eq!(::std::mem::size_of::<Parameters__bindgen_ty_1>() , 24usize ,
               concat ! (
               "Size of: " , stringify ! ( Parameters__bindgen_ty_1 ) ));
    assert_eq! (::std::mem::align_of::<Parameters__bindgen_ty_1>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( Parameters__bindgen_ty_1 ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Parameters__bindgen_ty_1 ) ) . array as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                Parameters__bindgen_ty_1 ) , "::" , stringify ! ( array ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Parameters__bindgen_ty_1 ) ) . count as *
                const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! (
                Parameters__bindgen_ty_1 ) , "::" , stringify ! ( count ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Parameters__bindgen_ty_1 ) ) . size as *
                const _ as usize } , 12usize , concat ! (
                "Alignment of field: " , stringify ! (
                Parameters__bindgen_ty_1 ) , "::" , stringify ! ( size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Parameters__bindgen_ty_1 ) ) . free as *
                const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! (
                Parameters__bindgen_ty_1 ) , "::" , stringify ! ( free ) ));
}
impl Clone for Parameters__bindgen_ty_1 {
    fn clone(&self) -> Self { *self }
}
#[test]
fn bindgen_test_layout_Parameters() {
    assert_eq!(::std::mem::size_of::<Parameters>() , 48usize , concat ! (
               "Size of: " , stringify ! ( Parameters ) ));
    assert_eq! (::std::mem::align_of::<Parameters>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( Parameters ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Parameters ) ) . list as * const _ as
                usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( Parameters ) , "::" ,
                stringify ! ( list ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Parameters ) ) . _asn_ctx as * const _ as
                usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( Parameters ) , "::" ,
                stringify ! ( _asn_ctx ) ));
}
...
fn bindgen_test_layout_RoadSection() {
    assert_eq!(::std::mem::size_of::<RoadSection>() , 80usize , concat ! (
               "Size of: " , stringify ! ( RoadSection ) ));
    assert_eq! (::std::mem::align_of::<RoadSection>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( RoadSection ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const RoadSection ) ) . geo_fence_id as * const
                _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( RoadSection ) , "::" ,
                stringify ! ( geo_fence_id ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const RoadSection ) ) . parameters as * const _
                as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( RoadSection ) , "::" ,
                stringify ! ( parameters ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const RoadSection ) ) . _asn_ctx as * const _
                as usize } , 56usize , concat ! (
                "Alignment of field: " , stringify ! ( RoadSection ) , "::" ,
                stringify ! ( _asn_ctx ) ));
}
impl Clone for RoadSection {
    fn clone(&self) -> Self { *self }
}
pub type RoadSection_t = RoadSection;
extern "C" {
    #[link_name = "asn_DEF_RoadSection"]
...
fn bindgen_test_layout_RoadSections__bindgen_ty_1() {
    assert_eq!(::std::mem::size_of::<RoadSections__bindgen_ty_1>() , 24usize ,
               concat ! (
               "Size of: " , stringify ! ( RoadSections__bindgen_ty_1 ) ));
    assert_eq! (::std::mem::align_of::<RoadSections__bindgen_ty_1>() , 8usize
                , concat ! (
                "Alignment of " , stringify ! ( RoadSections__bindgen_ty_1 )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const RoadSections__bindgen_ty_1 ) ) . array as
                * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                RoadSections__bindgen_ty_1 ) , "::" , stringify ! ( array )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const RoadSections__bindgen_ty_1 ) ) . count as
                * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! (
                RoadSections__bindgen_ty_1 ) , "::" , stringify ! ( count )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const RoadSections__bindgen_ty_1 ) ) . size as
                * const _ as usize } , 12usize , concat ! (
                "Alignment of field: " , stringify ! (
                RoadSections__bindgen_ty_1 ) , "::" , stringify ! ( size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const RoadSections__bindgen_ty_1 ) ) . free as
                * const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! (
                RoadSections__bindgen_ty_1 ) , "::" , stringify ! ( free ) ));
}
impl Clone for RoadSections__bindgen_ty_1 {
    fn clone(&self) -> Self { *self }
}
#[test]
fn bindgen_test_layout_RoadSections() {
    assert_eq!(::std::mem::size_of::<RoadSections>() , 48usize , concat ! (
               "Size of: " , stringify ! ( RoadSections ) ));
    assert_eq! (::std::mem::align_of::<RoadSections>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( RoadSections ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const RoadSections ) ) . list as * const _ as
                usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( RoadSections ) , "::" ,
                stringify ! ( list ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const RoadSections ) ) . _asn_ctx as * const _
                as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( RoadSections ) , "::" ,
                stringify ! ( _asn_ctx ) ));
}
impl Clone for RoadSections {
    fn clone(&self) -> Self { *self }
}
pub type RoadSections_t = RoadSections;
extern "C" {
    #[link_name = "asn_DEF_RoadSections"]
...
fn bindgen_test_layout_RoadClearanceFrame() {
    assert_eq!(::std::mem::size_of::<RoadClearanceFrame>() , 192usize , concat
               ! ( "Size of: " , stringify ! ( RoadClearanceFrame ) ));
    assert_eq! (::std::mem::align_of::<RoadClearanceFrame>() , 8usize , concat
                ! ( "Alignment of " , stringify ! ( RoadClearanceFrame ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const RoadClearanceFrame ) ) . header as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( RoadClearanceFrame ) ,
                "::" , stringify ! ( header ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const RoadClearanceFrame ) ) . envelope as *
                const _ as usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! ( RoadClearanceFrame ) ,
                "::" , stringify ! ( envelope ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const RoadClearanceFrame ) ) . road_sections as
                * const _ as usize } , 120usize , concat ! (
                "Alignment of field: " , stringify ! ( RoadClearanceFrame ) ,
                "::" , stringify ! ( road_sections ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const RoadClearanceFrame ) ) . _asn_ctx as *
                const _ as usize } , 168usize , concat ! (
                "Alignment of field: " , stringify ! ( RoadClearanceFrame ) ,
                "::" , stringify ! ( _asn_ctx ) ));
}
impl Clone for RoadClearanceFrame {
    fn clone(&self) -> Self { *self }
}
pub type RoadClearanceFrame_t = RoadClearanceFrame;
extern "C" {
    #[link_name = "asn_DEF_RoadClearanceFrame"]
    pub static mut asn_DEF_RoadClearanceFrame: asn_TYPE_descriptor_t;
}
#[repr(u32)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
pub enum ClientType { ClientType_sensor = 0, ClientType_vehicle = 1, }
pub use self::ClientType as e_ClientType;
pub type ClientType_t = ::std::os::raw::c_long;
extern "C" {
    #[link_name = "asn_DEF_ClientType"]
    pub static mut asn_DEF_ClientType: asn_TYPE_descriptor_t;
}
extern "C" {
    pub fn ClientType_free(type_descriptor: *mut asn_TYPE_descriptor_s,
                           struct_ptr: *mut ::std::os::raw::c_void,
                           free_contents_only: ::std::os::raw::c_int);
}
extern "C" {
    pub fn ClientType_print(type_descriptor: *mut asn_TYPE_descriptor_s,
                            struct_ptr: *const ::std::os::raw::c_void,
                            level: ::std::os::raw::c_int,
                            callback: asn_app_consume_bytes_f,
                            app_key: *mut ::std::os::raw::c_void)
...
extern "C" {
    pub fn ClientType_constraint(type_descriptor: *mut asn_TYPE_descriptor_s,
                                 struct_ptr: *const ::std::os::raw::c_void,
                                 optional_callback:
                                     asn_app_constraint_failed_f,
                                 optional_app_key:
...
extern "C" {
    pub fn ClientType_decode_ber(opt_codec_ctx: *mut asn_codec_ctx_s,
                                 type_descriptor: *mut asn_TYPE_descriptor_s,
                                 struct_ptr: *mut *mut ::std::os::raw::c_void,
                                 buf_ptr: *const ::std::os::raw::c_void,
                                 size: usize, tag_mode: ::std::os::raw::c_int)
...
extern "C" {
    pub fn ClientType_encode_der(type_descriptor: *mut asn_TYPE_descriptor_s,
                                 struct_ptr: *mut ::std::os::raw::c_void,
                                 tag_mode: ::std::os::raw::c_int,
                                 tag: ber_tlv_tag_t,
                                 consume_bytes_cb: asn_app_consume_bytes_f,
...
extern "C" {
    pub fn ClientType_decode_xer(opt_codec_ctx: *mut asn_codec_ctx_t,
                                 type_descriptor: *mut asn_TYPE_descriptor_s,
                                 struct_ptr: *mut *mut ::std::os::raw::c_void,
                                 opt_mname: *const ::std::os::raw::c_char,
                                 buf_ptr: *const ::std::os::raw::c_void,
...
extern "C" {
    pub fn ClientType_encode_xer(type_descriptor: *mut asn_TYPE_descriptor_s,
                                 struct_ptr: *mut ::std::os::raw::c_void,
                                 ilevel: ::std::os::raw::c_int,
                                 xer_flags: xer_encoder_flags_e,
                                 consume_bytes_cb: asn_app_consume_bytes_f,
...
extern "C" {
    pub fn ClientType_decode_uper(opt_codec_ctx: *mut asn_codec_ctx_t,
                                  type_descriptor: *mut asn_TYPE_descriptor_s,
                                  constraints: *mut asn_per_constraints_t,
                                  struct_ptr:
                                      *mut *mut ::std::os::raw::c_void,
...
extern "C" {
    pub fn ClientType_encode_uper(type_descriptor: *mut asn_TYPE_descriptor_s,
                                  constraints: *mut asn_per_constraints_t,
                                  struct_ptr: *mut ::std::os::raw::c_void,
                                  per_output: *mut asn_per_outp_t)
     -> asn_enc_rval_t;
...
fn bindgen_test_layout_CoveredArea__bindgen_ty_1() {
    assert_eq!(::std::mem::size_of::<CoveredArea__bindgen_ty_1>() , 24usize ,
               concat ! (
               "Size of: " , stringify ! ( CoveredArea__bindgen_ty_1 ) ));
    assert_eq! (::std::mem::align_of::<CoveredArea__bindgen_ty_1>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( CoveredArea__bindgen_ty_1 )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const CoveredArea__bindgen_ty_1 ) ) . array as
                * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                CoveredArea__bindgen_ty_1 ) , "::" , stringify ! ( array ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const CoveredArea__bindgen_ty_1 ) ) . count as
                * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! (
                CoveredArea__bindgen_ty_1 ) , "::" , stringify ! ( count ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const CoveredArea__bindgen_ty_1 ) ) . size as *
                const _ as usize } , 12usize , concat ! (
                "Alignment of field: " , stringify ! (
                CoveredArea__bindgen_ty_1 ) , "::" , stringify ! ( size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const CoveredArea__bindgen_ty_1 ) ) . free as *
                const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! (
                CoveredArea__bindgen_ty_1 ) , "::" , stringify ! ( free ) ));
}
impl Clone for CoveredArea__bindgen_ty_1 {
    fn clone(&self) -> Self { *self }
}
#[test]
fn bindgen_test_layout_CoveredArea() {
    assert_eq!(::std::mem::size_of::<CoveredArea>() , 48usize , concat ! (
               "Size of: " , stringify ! ( CoveredArea ) ));
    assert_eq! (::std::mem::align_of::<CoveredArea>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( CoveredArea ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const CoveredArea ) ) . list as * const _ as
                usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( CoveredArea ) , "::" ,
                stringify ! ( list ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const CoveredArea ) ) . _asn_ctx as * const _
                as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( CoveredArea ) , "::" ,
                stringify ! ( _asn_ctx ) ));
}
impl Clone for CoveredArea {
    fn clone(&self) -> Self { *self }
}
pub type CoveredArea_t = CoveredArea;
extern "C" {
    #[link_name = "asn_DEF_CoveredArea"]
...
extern "C" {
    #[link_name = "asn_DEF_SubscriptionStatus"]
    pub static mut asn_DEF_SubscriptionStatus: asn_TYPE_descriptor_t;
}
extern "C" {
    pub fn SubscriptionStatus_free(type_descriptor:
                                       *mut asn_TYPE_descriptor_s,
                                   struct_ptr: *mut ::std::os::raw::c_void,
                                   free_contents_only: ::std::os::raw::c_int);
}
extern "C" {
    pub fn SubscriptionStatus_print(type_descriptor:
                                        *mut asn_TYPE_descriptor_s,
                                    struct_ptr: *const ::std::os::raw::c_void,
                                    level: ::std::os::raw::c_int,
                                    callback: asn_app_consume_bytes_f,
...
extern "C" {
    pub fn SubscriptionStatus_constraint(type_descriptor:
                                             *mut asn_TYPE_descriptor_s,
                                         struct_ptr:
                                             *const ::std::os::raw::c_void,
                                         optional_callback:
...
extern "C" {
    pub fn SubscriptionStatus_decode_ber(opt_codec_ctx: *mut asn_codec_ctx_s,
                                         type_descriptor:
                                             *mut asn_TYPE_descriptor_s,
                                         struct_ptr:
                                             *mut *mut ::std::os::raw::c_void,
...
extern "C" {
    pub fn SubscriptionStatus_encode_der(type_descriptor:
                                             *mut asn_TYPE_descriptor_s,
                                         struct_ptr:
                                             *mut ::std::os::raw::c_void,
                                         tag_mode: ::std::os::raw::c_int,
...
extern "C" {
    pub fn SubscriptionStatus_decode_xer(opt_codec_ctx: *mut asn_codec_ctx_t,
                                         type_descriptor:
                                             *mut asn_TYPE_descriptor_s,
                                         struct_ptr:
                                             *mut *mut ::std::os::raw::c_void,
...
extern "C" {
    pub fn SubscriptionStatus_encode_xer(type_descriptor:
                                             *mut asn_TYPE_descriptor_s,
                                         struct_ptr:
                                             *mut ::std::os::raw::c_void,
                                         ilevel: ::std::os::raw::c_int,
...
extern "C" {
    pub fn SubscriptionStatus_decode_uper(opt_codec_ctx: *mut asn_codec_ctx_t,
                                          type_descriptor:
                                              *mut asn_TYPE_descriptor_s,
                                          constraints:
                                              *mut asn_per_constraints_t,
...
extern "C" {
    pub fn SubscriptionStatus_encode_uper(type_descriptor:
                                              *mut asn_TYPE_descriptor_s,
                                          constraints:
                                              *mut asn_per_constraints_t,
                                          struct_ptr:
...
fn bindgen_test_layout_ClientRegistration() {
    assert_eq!(::std::mem::size_of::<ClientRegistration>() , 48usize , concat
               ! ( "Size of: " , stringify ! ( ClientRegistration ) ));
    assert_eq! (::std::mem::align_of::<ClientRegistration>() , 8usize , concat
                ! ( "Alignment of " , stringify ! ( ClientRegistration ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const ClientRegistration ) ) . type_ as * const
                _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( ClientRegistration ) ,
                "::" , stringify ! ( type_ ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const ClientRegistration ) ) . covered_area as
                * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( ClientRegistration ) ,
                "::" , stringify ! ( covered_area ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const ClientRegistration ) ) .
                minimum_message_period as * const _ as usize } , 16usize ,
                concat ! (
                "Alignment of field: " , stringify ! ( ClientRegistration ) ,
                "::" , stringify ! ( minimum_message_period ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const ClientRegistration ) ) . _asn_ctx as *
                const _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( ClientRegistration ) ,
                "::" , stringify ! ( _asn_ctx ) ));
}
...
extern "C" {
    #[link_name = "asn_DEF_ClientRegistration"]
...
fn bindgen_test_layout_UpdateSubscription() {
    assert_eq!(::std::mem::size_of::<UpdateSubscription>() , 40usize , concat
               ! ( "Size of: " , stringify ! ( UpdateSubscription ) ));
    assert_eq! (::std::mem::align_of::<UpdateSubscription>() , 8usize , concat
                ! ( "Alignment of " , stringify ! ( UpdateSubscription ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const UpdateSubscription ) ) .
                subscription_status as * const _ as usize } , 0usize , concat
                ! (
                "Alignment of field: " , stringify ! ( UpdateSubscription ) ,
                "::" , stringify ! ( subscription_status ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const UpdateSubscription ) ) . message_period
                as * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( UpdateSubscription ) ,
                "::" , stringify ! ( message_period ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const UpdateSubscription ) ) . _asn_ctx as *
                const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( UpdateSubscription ) ,
                "::" , stringify ! ( _asn_ctx ) ));
}
...
extern "C" {
    #[link_name = "asn_DEF_UpdateSubscription"]
...
extern "C" {
    #[link_name = "asn_DEF_ConnectionStatus"]
    pub static mut asn_DEF_ConnectionStatus: asn_TYPE_descriptor_t;
}
extern "C" {
    pub fn ConnectionStatus_free(type_descriptor: *mut asn_TYPE_descriptor_s,
                                 struct_ptr: *mut ::std::os::raw::c_void,
                                 free_contents_only: ::std::os::raw::c_int);
}
extern "C" {
    pub fn ConnectionStatus_print(type_descriptor: *mut asn_TYPE_descriptor_s,
                                  struct_ptr: *const ::std::os::raw::c_void,
                                  level: ::std::os::raw::c_int,
                                  callback: asn_app_consume_bytes_f,
                                  app_key: *mut ::std::os::raw::c_void)
...
extern "C" {
    pub fn ConnectionStatus_constraint(type_descriptor:
                                           *mut asn_TYPE_descriptor_s,
                                       struct_ptr:
                                           *const ::std::os::raw::c_void,
                                       optional_callback:
...
extern "C" {
    pub fn ConnectionStatus_decode_ber(opt_codec_ctx: *mut asn_codec_ctx_s,
                                       type_descriptor:
                                           *mut asn_TYPE_descriptor_s,
                                       struct_ptr:
                                           *mut *mut ::std::os::raw::c_void,
...
extern "C" {
    pub fn ConnectionStatus_encode_der(type_descriptor:
                                           *mut asn_TYPE_descriptor_s,
                                       struct_ptr:
                                           *mut ::std::os::raw::c_void,
                                       tag_mode: ::std::os::raw::c_int,
...
extern "C" {
    pub fn ConnectionStatus_decode_xer(opt_codec_ctx: *mut asn_codec_ctx_t,
                                       type_descriptor:
                                           *mut asn_TYPE_descriptor_s,
                                       struct_ptr:
                                           *mut *mut ::std::os::raw::c_void,
...
extern "C" {
    pub fn ConnectionStatus_encode_xer(type_descriptor:
                                           *mut asn_TYPE_descriptor_s,
                                       struct_ptr:
                                           *mut ::std::os::raw::c_void,
                                       ilevel: ::std::os::raw::c_int,
...
extern "C" {
    pub fn ConnectionStatus_decode_uper(opt_codec_ctx: *mut asn_codec_ctx_t,
                                        type_descriptor:
                                            *mut asn_TYPE_descriptor_s,
                                        constraints:
                                            *mut asn_per_constraints_t,
...
extern "C" {
    pub fn ConnectionStatus_encode_uper(type_descriptor:
                                            *mut asn_TYPE_descriptor_s,
                                        constraints:
                                            *mut asn_per_constraints_t,
                                        struct_ptr:
...
fn bindgen_test_layout_UpdateStatus() {
    assert_eq!(::std::mem::size_of::<UpdateStatus>() , 80usize , concat ! (
               "Size of: " , stringify ! ( UpdateStatus ) ));
    assert_eq! (::std::mem::align_of::<UpdateStatus>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( UpdateStatus ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const UpdateStatus ) ) . sensor_status as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( UpdateStatus ) , "::" ,
                stringify ! ( sensor_status ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const UpdateStatus ) ) . ip_address as * const
                _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( UpdateStatus ) , "::" ,
                stringify ! ( ip_address ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const UpdateStatus ) ) . sensor_id as * const _
                as usize } , 48usize , concat ! (
                "Alignment of field: " , stringify ! ( UpdateStatus ) , "::" ,
                stringify ! ( sensor_id ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const UpdateStatus ) ) . _asn_ctx as * const _
                as usize } , 56usize , concat ! (
                "Alignment of field: " , stringify ! ( UpdateStatus ) , "::" ,
                stringify ! ( _asn_ctx ) ));
}
...
extern "C" {
    #[link_name = "asn_DEF_UpdateStatus"]
...
extern "C" {
    #[link_name = "asn_DEF_SensorType"]
    pub static mut asn_DEF_SensorType: asn_TYPE_descriptor_t;
}
extern "C" {
    pub fn SensorType_free(type_descriptor: *mut asn_TYPE_descriptor_s,
                           struct_ptr: *mut ::std::os::raw::c_void,
                           free_contents_only: ::std::os::raw::c_int);
}
extern "C" {
    pub fn SensorType_print(type_descriptor: *mut asn_TYPE_descriptor_s,
                            struct_ptr: *const ::std::os::raw::c_void,
                            level: ::std::os::raw::c_int,
                            callback: asn_app_consume_bytes_f,
                            app_key: *mut ::std::os::raw::c_void)
...
extern "C" {
    pub fn SensorType_constraint(type_descriptor: *mut asn_TYPE_descriptor_s,
                                 struct_ptr: *const ::std::os::raw::c_void,
                                 optional_callback:
                                     asn_app_constraint_failed_f,
                                 optional_app_key:
...
extern "C" {
    pub fn SensorType_decode_ber(opt_codec_ctx: *mut asn_codec_ctx_s,
                                 type_descriptor: *mut asn_TYPE_descriptor_s,
                                 struct_ptr: *mut *mut ::std::os::raw::c_void,
                                 buf_ptr: *const ::std::os::raw::c_void,
                                 size: usize, tag_mode: ::std::os::raw::c_int)
...
extern "C" {
    pub fn SensorType_encode_der(type_descriptor: *mut asn_TYPE_descriptor_s,
                                 struct_ptr: *mut ::std::os::raw::c_void,
                                 tag_mode: ::std::os::raw::c_int,
                                 tag: ber_tlv_tag_t,
                                 consume_bytes_cb: asn_app_consume_bytes_f,
...
extern "C" {
    pub fn SensorType_decode_xer(opt_codec_ctx: *mut asn_codec_ctx_t,
                                 type_descriptor: *mut asn_TYPE_descriptor_s,
                                 struct_ptr: *mut *mut ::std::os::raw::c_void,
                                 opt_mname: *const ::std::os::raw::c_char,
                                 buf_ptr: *const ::std::os::raw::c_void,
...
extern "C" {
    pub fn SensorType_encode_xer(type_descriptor: *mut asn_TYPE_descriptor_s,
                                 struct_ptr: *mut ::std::os::raw::c_void,
                                 ilevel: ::std::os::raw::c_int,
                                 xer_flags: xer_encoder_flags_e,
                                 consume_bytes_cb: asn_app_consume_bytes_f,
...
extern "C" {
    pub fn SensorType_decode_uper(opt_codec_ctx: *mut asn_codec_ctx_t,
                                  type_descriptor: *mut asn_TYPE_descriptor_s,
                                  constraints: *mut asn_per_constraints_t,
                                  struct_ptr:
                                      *mut *mut ::std::os::raw::c_void,
...
extern "C" {
    pub fn SensorType_encode_uper(type_descriptor: *mut asn_TYPE_descriptor_s,
                                  constraints: *mut asn_per_constraints_t,
                                  struct_ptr: *mut ::std::os::raw::c_void,
                                  per_output: *mut asn_per_outp_t)
     -> asn_enc_rval_t;
...
fn bindgen_test_layout_SensorEnvelope() {
    assert_eq!(::std::mem::size_of::<SensorEnvelope>() , 112usize , concat ! (
               "Size of: " , stringify ! ( SensorEnvelope ) ));
    assert_eq! (::std::mem::align_of::<SensorEnvelope>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( SensorEnvelope ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SensorEnvelope ) ) . version as * const _
                as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( SensorEnvelope ) , "::"
                , stringify ! ( version ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SensorEnvelope ) ) . sensor_type as *
                const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( SensorEnvelope ) , "::"
                , stringify ! ( sensor_type ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SensorEnvelope ) ) . sender_id as * const
                _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( SensorEnvelope ) , "::"
                , stringify ! ( sender_id ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SensorEnvelope ) ) . pole_id as * const _
                as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( SensorEnvelope ) , "::"
                , stringify ! ( pole_id ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SensorEnvelope ) ) . reference_point as *
                const _ as usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! ( SensorEnvelope ) , "::"
                , stringify ! ( reference_point ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SensorEnvelope ) ) . error_code as *
                const _ as usize } , 80usize , concat ! (
                "Alignment of field: " , stringify ! ( SensorEnvelope ) , "::"
                , stringify ! ( error_code ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SensorEnvelope ) ) . _asn_ctx as * const
                _ as usize } , 88usize , concat ! (
                "Alignment of field: " , stringify ! ( SensorEnvelope ) , "::"
                , stringify ! ( _asn_ctx ) ));
}
impl Clone for SensorEnvelope {
    fn clone(&self) -> Self { *self }
}
pub type SensorEnvelope_t = SensorEnvelope;
extern "C" {
    #[link_name = "asn_DEF_SensorEnvelope"]
...
fn bindgen_test_layout_SensorObjectDetection() {
    assert_eq!(::std::mem::size_of::<SensorObjectDetection>() , 216usize ,
               concat ! ( "Size of: " , stringify ! ( SensorObjectDetection )
               ));
    assert_eq! (::std::mem::align_of::<SensorObjectDetection>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( SensorObjectDetection ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SensorObjectDetection ) ) . local_id as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( SensorObjectDetection )
                , "::" , stringify ! ( local_id ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SensorObjectDetection ) ) .
                probability_of_existence as * const _ as usize } , 8usize ,
                concat ! (
                "Alignment of field: " , stringify ! ( SensorObjectDetection )
                , "::" , stringify ! ( probability_of_existence ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SensorObjectDetection ) ) .
                position_offset as * const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( SensorObjectDetection )
                , "::" , stringify ! ( position_offset ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SensorObjectDetection ) ) . moving_vector
                as * const _ as usize } , 72usize , concat ! (
                "Alignment of field: " , stringify ! ( SensorObjectDetection )
                , "::" , stringify ! ( moving_vector ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SensorObjectDetection ) ) . type_ as *
                const _ as usize } , 80usize , concat ! (
                "Alignment of field: " , stringify ! ( SensorObjectDetection )
                , "::" , stringify ! ( type_ ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SensorObjectDetection ) ) .
                type_probability as * const _ as usize } , 88usize , concat !
                (
                "Alignment of field: " , stringify ! ( SensorObjectDetection )
                , "::" , stringify ! ( type_probability ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SensorObjectDetection ) ) . size as *
                const _ as usize } , 96usize , concat ! (
                "Alignment of field: " , stringify ! ( SensorObjectDetection )
                , "::" , stringify ! ( size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SensorObjectDetection ) ) . orientation
                as * const _ as usize } , 168usize , concat ! (
                "Alignment of field: " , stringify ! ( SensorObjectDetection )
                , "::" , stringify ! ( orientation ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SensorObjectDetection ) ) .
                std_dev_orientation as * const _ as usize } , 176usize ,
                concat ! (
                "Alignment of field: " , stringify ! ( SensorObjectDetection )
                , "::" , stringify ! ( std_dev_orientation ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SensorObjectDetection ) ) . measured as *
                const _ as usize } , 184usize , concat ! (
                "Alignment of field: " , stringify ! ( SensorObjectDetection )
                , "::" , stringify ! ( measured ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SensorObjectDetection ) ) . _asn_ctx as *
                const _ as usize } , 192usize , concat ! (
                "Alignment of field: " , stringify ! ( SensorObjectDetection )
                , "::" , stringify ! ( _asn_ctx ) ));
}
impl Clone for SensorObjectDetection {
    fn clone(&self) -> Self { *self }
}
pub type SensorObjectDetection_t = SensorObjectDetection;
extern "C" {
    #[link_name = "asn_DEF_SensorObjectDetection"]
...
pub struct SensorObjectDetections__bindgen_ty_1 {
    ...
    pub size: ::std::os::raw::c_int,
    pub free: ::std::option::Option<unsafe extern "C" fn(arg1:
                                                             *mut SensorObjectDetection)>,
}
#[test]
fn bindgen_test_layout_SensorObjectDetections__bindgen_ty_1() {
    assert_eq!(::std::mem::size_of::<SensorObjectDetections__bindgen_ty_1>() ,
               24usize , concat ! (
               "Size of: " , stringify ! (
               SensorObjectDetections__bindgen_ty_1 ) ));
    assert_eq! (::std::mem::align_of::<SensorObjectDetections__bindgen_ty_1>()
                , 8usize , concat ! (
                "Alignment of " , stringify ! (
                SensorObjectDetections__bindgen_ty_1 ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SensorObjectDetections__bindgen_ty_1 ) )
                . array as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                SensorObjectDetections__bindgen_ty_1 ) , "::" , stringify ! (
                array ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SensorObjectDetections__bindgen_ty_1 ) )
                . count as * const _ as usize } , 8usize , concat ! (
...
impl Clone for SensorObjectDetections__bindgen_ty_1 {
    fn clone(&self) -> Self { *self }
}
#[test]
fn bindgen_test_layout_SensorObjectDetections() {
    assert_eq!(::std::mem::size_of::<SensorObjectDetections>() , 48usize ,
               concat ! ( "Size of: " , stringify ! ( SensorObjectDetections )
               ));
    assert_eq! (::std::mem::align_of::<SensorObjectDetections>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( SensorObjectDetections ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SensorObjectDetections ) ) . list as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( SensorObjectDetections
                ) , "::" , stringify ! ( list ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SensorObjectDetections ) ) . _asn_ctx as
                * const _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( SensorObjectDetections
                ) , "::" , stringify ! ( _asn_ctx ) ));
}
impl Clone for SensorObjectDetections {
    fn clone(&self) -> Self { *self }
}
pub type SensorObjectDetections_t = SensorObjectDetections;
extern "C" {
    #[link_name = "asn_DEF_SensorObjectDetections"]
...
fn bindgen_test_layout_SensorFrame() {
    assert_eq!(::std::mem::size_of::<SensorFrame>() , 216usize , concat ! (
               "Size of: " , stringify ! ( SensorFrame ) ));
    assert_eq! (::std::mem::align_of::<SensorFrame>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( SensorFrame ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SensorFrame ) ) . header as * const _ as
                usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( SensorFrame ) , "::" ,
                stringify ! ( header ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SensorFrame ) ) . envelope as * const _
                as usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! ( SensorFrame ) , "::" ,
                stringify ! ( envelope ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SensorFrame ) ) . object_detections as *
                const _ as usize } , 144usize , concat ! (
                "Alignment of field: " , stringify ! ( SensorFrame ) , "::" ,
                stringify ! ( object_detections ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SensorFrame ) ) . _asn_ctx as * const _
                as usize } , 192usize , concat ! (
                "Alignment of field: " , stringify ! ( SensorFrame ) , "::" ,
                stringify ! ( _asn_ctx ) ));
}
impl Clone for SensorFrame {
    fn clone(&self) -> Self { *self }
}
pub type SensorFrame_t = SensorFrame;
extern "C" {
    #[link_name = "asn_DEF_SensorFrame"]
...
fn bindgen_test_layout_SensorIdleFrame() {
    assert_eq!(::std::mem::size_of::<SensorIdleFrame>() , 48usize , concat ! (
               "Size of: " , stringify ! ( SensorIdleFrame ) ));
    assert_eq! (::std::mem::align_of::<SensorIdleFrame>() , 8usize , concat !
                ( "Alignment of " , stringify ! ( SensorIdleFrame ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SensorIdleFrame ) ) . version as * const
                _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( SensorIdleFrame ) ,
                "::" , stringify ! ( version ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SensorIdleFrame ) ) . sender_id as *
                const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( SensorIdleFrame ) ,
                "::" , stringify ! ( sender_id ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SensorIdleFrame ) ) . pole_id as * const
                _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( SensorIdleFrame ) ,
                "::" , stringify ! ( pole_id ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const SensorIdleFrame ) ) . _asn_ctx as * const
                _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( SensorIdleFrame ) ,
                "::" , stringify ! ( _asn_ctx ) ));
}
impl Clone for SensorIdleFrame {
    fn clone(&self) -> Self { *self }
}
pub type SensorIdleFrame_t = SensorIdleFrame;
extern "C" {
    #[link_name = "asn_DEF_SensorIdleFrame"]
...
fn bindgen_test_layout_BIT_STRING_s() {
    assert_eq!(::std::mem::size_of::<BIT_STRING_s>() , 40usize , concat ! (
               "Size of: " , stringify ! ( BIT_STRING_s ) ));
    assert_eq! (::std::mem::align_of::<BIT_STRING_s>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( BIT_STRING_s ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const BIT_STRING_s ) ) . buf as * const _ as
                usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( BIT_STRING_s ) , "::" ,
                stringify ! ( buf ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const BIT_STRING_s ) ) . size as * const _ as
                usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( BIT_STRING_s ) , "::" ,
                stringify ! ( size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const BIT_STRING_s ) ) . bits_unused as * const
                _ as usize } , 12usize , concat ! (
                "Alignment of field: " , stringify ! ( BIT_STRING_s ) , "::" ,
                stringify ! ( bits_unused ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const BIT_STRING_s ) ) . _asn_ctx as * const _
                as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( BIT_STRING_s ) , "::" ,
                stringify ! ( _asn_ctx ) ));
}
impl Clone for BIT_STRING_s {
    fn clone(&self) -> Self { *self }
}
pub type BIT_STRING_t = BIT_STRING_s;
extern "C" {
    #[link_name = "asn_DEF_BIT_STRING"]
    pub static mut asn_DEF_BIT_STRING: asn_TYPE_descriptor_t;
}
extern "C" {
    pub fn BIT_STRING_print(type_descriptor: *mut asn_TYPE_descriptor_s,
                            struct_ptr: *const ::std::os::raw::c_void,
                            level: ::std::os::raw::c_int,
                            callback: asn_app_consume_bytes_f,
                            app_key: *mut ::std::os::raw::c_void)
...
extern "C" {
    pub fn BIT_STRING_constraint(type_descriptor: *mut asn_TYPE_descriptor_s,
                                 struct_ptr: *const ::std::os::raw::c_void,
                                 optional_callback:
                                     asn_app_constraint_failed_f,
                                 optional_app_key:
...
extern "C" {
    pub fn BIT_STRING_encode_xer(type_descriptor: *mut asn_TYPE_descriptor_s,
                                 struct_ptr: *mut ::std::os::raw::c_void,
                                 ilevel: ::std::os::raw::c_int,
                                 xer_flags: xer_encoder_flags_e,
                                 consume_bytes_cb: asn_app_consume_bytes_f,
...
pub type pxml_callback_f =
    ::std::option::Option<unsafe extern "C" fn(_type: pxml_chunk_type_e,
                                               _chunk_data:
                                                   *const ::std::os::raw::c_void,
                                               _chunk_size: usize,
                                               _key:
                              ...
                              -> ::std::os::raw::c_int>;
extern "C" {
    pub fn pxml_parse(_stateContext: *mut ::std::os::raw::c_int,
                      _buf: *const ::std::os::raw::c_void, _size: usize,
                      cb: pxml_callback_f, _key: *mut ::std::os::raw::c_void)
     -> isize;
}
extern "C" {
    pub fn uper_open_type_get(opt_codec_ctx: *mut asn_codec_ctx_t,
                              td: *mut asn_TYPE_descriptor_t,
                              constraints: *mut asn_per_constraints_t,
                              sptr: *mut *mut ::std::os::raw::c_void,
                              pd: *mut asn_per_data_t) -> asn_dec_rval_t;
}
extern "C" {
    pub fn uper_open_type_skip(opt_codec_ctx: *mut asn_codec_ctx_t,
                               pd: *mut asn_per_data_t)
     -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn uper_open_type_put(td: *mut asn_TYPE_descriptor_t,
                              constraints: *mut asn_per_constraints_t,
                              sptr: *mut ::std::os::raw::c_void,
