...
Die Standardbibliothek wird selbst als eine Crate (siehe \autoref{rust:structure:crate}) zur Verfügung gestellt, auf die standardmäßige eine Abhängigkeit besteht.
