...
Während dies in Programmiersprachen wie Java und C\# automatisch abstrahiert wird (\todo{virtuelle methoden, vergleich c++, speicher, indirekt}), wird dies in Rust aus Performancegründen nicht getan.
