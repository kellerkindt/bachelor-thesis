...
Eine Panik bedeutet in den meisten Fällen einen Logikfehler im Programmcode, weswegen dieser nicht wie ein normaler Fehler behandelt wird.
...
Auch, wenn beim freigeben des Speichers, durch zum Beispiel eine eigene \rustcinline{Drop} Implementation (siehe \autoref{rust:traits}), eine weitere Panik auftritt, wird der Prozess beendet (dies wird \rustcinline{abort} genannt) \cite[145-147]{rust:orly_programming}.
