...
\requirement{exec:time}{Reaktionszeit des Servers}{Die Implementation des Servers soll Nachrichten von \todo{20} gleichzeitigen Sensoren und \todo{50} gleichzeitigen Fahrzeugen innerhalb von \todo{10ms} beantworten können.
