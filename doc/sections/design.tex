...
Die \textit{asn::Message} soll Methoden bereitstellen, eine ASN.1 Nachricht in eine \textit{RawMessage} zu serialisieren und eine ASN.1 Nachricht aus einer \textit{RawMessage} zu deserialisieren.
